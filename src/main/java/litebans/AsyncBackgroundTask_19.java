...
implements Runnable {
    ...
    final /* synthetic */ LiteBansModule_83 BaseCoreGenericHandler;
    final /* synthetic */ Entry LiteBansModule_31;

    public AsyncBackgroundTask_19(Collection collection, LiteBansModule_83 ch2, Entry entry) {
        this.c = collection;
        this.plugin = ch2;
    ...
    public final void run() {
        ...
        LiteBansModule_83 ch2 = this.plugin;
