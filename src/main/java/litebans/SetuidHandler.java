...
extends Enum {
    ...
    public static final SetuidHandler LiteBansModule_403 = new SetuidHandler("STICKY", 2, 512);
    ...
    public static final SetuidHandler LiteBansModule_195 = new SetuidHandler("GROUP_READ", 6, 32);
    ...
    public static final SetuidHandler LiteBansModule_241 = new SetuidHandler("WORLD_WRITE", 10, 2);
    ...
    static {
        n = new SetuidHandler[]{c, m, LiteBansModule_403, Utf8Handler_2, AsyncBackgroundTask_5, BaseCoreGenericHandler, LiteBansModule_195, e, g, GnuSparseMapHandler, LiteBansModule_241, i};
    }
}
