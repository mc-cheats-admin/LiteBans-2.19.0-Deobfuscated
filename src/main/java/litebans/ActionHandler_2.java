...
public final class ActionHandler_2 {
     ...
     */
    public static final void BaseCoreGenericHandler(@NotNull Reader reader, @NotNull LiteBansModule_179 eo_02) {
        ...
        try {
            ...
            LiteBansModule_296 i_2 = ActionHandler_2.BaseCoreGenericHandler((BufferedReader)targetObj);
    ...
    public static final LiteBansModule_296 BaseCoreGenericHandler(@NotNull BufferedReader bufferedReader) {
        ObjectUtilities.BaseCoreGenericHandler((Object)bufferedReader, "<this>");
        return LiteBansModule_234.BaseCoreGenericHandler(new ReaderHandler(bufferedReader));
    }
    ...
    static {
        ActionHandler_2.BaseCoreGenericHandler();
    }
}
