...
extends DatabaseService {
    private NullHandler_4 LiteBansModule_240;
    ...
    public boolean c(String string) {
        return this.LiteBansModule_240.e(string) != null;
    }

    @Override
    public Object LiteBansModule_31(String string) {
        return this.LiteBansModule_240.e(string);
    }
    ...
    public boolean BaseCoreGenericHandler(String string) {
        return this.LiteBansModule_240.LiteBansModule_194(string);
    }
    ...
    public double AsyncBackgroundTask_5(String string) {
        return this.LiteBansModule_240.BaseCoreGenericHandler(string);
    }

    @Override
    public int BaseCoreGenericHandler(String string, int n) {
        return this.LiteBansModule_240.BaseCoreGenericHandler(string, n);
    }
    ...
    public long BaseCoreGenericHandler(String string, long l3) {
        return this.LiteBansModule_240.BaseCoreGenericHandler(string, l3);
    }
    ...
    public String e(String string) {
        return this.LiteBansModule_240.i(string);
    }

    @Override
    public String BaseCoreGenericHandler(String string, String string2) {
        try {
            return this.LiteBansModule_240.BaseCoreGenericHandler(string, string2);
        }
    ...
    public List g(String string) {
        return this.LiteBansModule_240.GnuSparseMapHandler(string);
    }
    ...
    public DatabaseService BaseCoreGenericHandler(InputStream inputStream) {
        ...
        try {
            this.plugin();
            this.LiteBansModule_240 = this.g.BaseCoreGenericHandler(new InputStreamReader(inputStream, Charsets.UTF_8));
        }
        catch (Exception exception) {
            this.plugin(exception);
            this.e();
    ...
    public DatabaseService BaseCoreGenericHandler(File file) {
        ...
        try {
            ...
            this.g.BaseCoreGenericHandler(this.LiteBansModule_240, stringWriter);
    ...
    public @Nullable LiteBansModule_390 BaseCoreGenericHandler(String string) {
        NullHandler_4 ie_02;
        try {
            ie_02 = this.LiteBansModule_240.LiteBansModule_31(string);
        }
        catch (ClassCastException classCastException) {
        ...
        return new LiteBansModule_68(this, ie_02);
    }
