...
implements Closeable {
    private final LiteBansModule_83 BaseCoreGenericHandler;
    private final PreparedStatement LiteBansModule_31;
    private final String c;
    private byte AsyncBackgroundTask_5;

    private LiteBansModule_60(LiteBansModule_83 ch2, PreparedStatement preparedStatement, String string) {
        this.plugin = ch2;
        this.LiteBansModule_31 = preparedStatement;
        this.c = string;
    }

    public final LiteBansModule_83 c() {
        return this.plugin;
    }
    ...
    public LiteBansModule_60 BaseCoreGenericHandler(boolean flag) {
        ...
        bT4.AsyncBackgroundTask_5 = LiteBansModule_284.BaseCoreGenericHandler((byte)(bT4.AsyncBackgroundTask_5 + 1));
    ...
    public final LiteBansModule_60 BaseCoreGenericHandler(@NotNull UUID uUID) {
        return this.plugin(LiteBansModule_287.BaseCoreGenericHandler(uUID));
    }
    ...
    public /* synthetic */ LiteBansModule_60(LiteBansModule_83 ch2, PreparedStatement preparedStatement, String string, LiteBansModule_14 aJ2) {
