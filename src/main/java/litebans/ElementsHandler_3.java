...
public final class ElementsHandler_3
implements Collection,
LiteBansModule_122 {
    public static final byte BaseCoreGenericHandler(byte[] byArray, int n) {
        return LiteBansModule_283.BaseCoreGenericHandler(byArray[n]);
    }

    public static int BaseCoreGenericHandler(byte[] byArray) {
