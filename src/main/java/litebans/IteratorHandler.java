...
extends LiteBansModule_224 {
    public static final LiteBansModule_295 BaseCoreGenericHandler(@NotNull LiteBansModule_295 i_2) {
        ObjectUtilities.BaseCoreGenericHandler(i_2, "<this>");
        return i_2 instanceof SequenceHandler ? i_2 : (LiteBansModule_295)new SequenceHandler(i_2);
    }
