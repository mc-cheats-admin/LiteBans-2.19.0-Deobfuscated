...
public final class LiteBansModule_244
implements LiteBansModule_82 {
    private final PlatformPlugin BaseCoreGenericHandler;

    public LiteBansModule_244(@NotNull PlatformPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public LiteBansModule_297 BaseCoreGenericHandler(@NotNull LiteBansModule_297 iA2, boolean flag) {
        return new LiteBansModule_297(null, null, null, new Date());
    }
    ...
    @Override
    public LiteBansModule_386 BaseCoreGenericHandler(@NotNull UUID uUID, int n) {
        return LiteBansModule_397.BaseCoreGenericHandler();
    }

    @Override
    public LiteBansModule_386 BaseCoreGenericHandler(@NotNull UUID uUID) {
        return LiteBansModule_397.BaseCoreGenericHandler();
    }
