...
extends Enum {
    ...
    public static final DesHandler LiteBansModule_403 = new DesHandler("RC2pre52", 1, 26114);
    public static final DesHandler c = new DesHandler("TripleDES168", 2, 26115);
    public static final DesHandler LiteBansModule_241 = new DesHandler("TripleDES192", 3, 26121);
    ...
    private final int LiteBansModule_195;
    ...
    static {
        i = new DesHandler[]{BaseCoreGenericHandler, LiteBansModule_403, c, LiteBansModule_241, m, AsyncBackgroundTask_5, LiteBansModule_31, e, g, GnuSparseMapHandler};
