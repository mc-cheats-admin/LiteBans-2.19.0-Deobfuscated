...
extends AbstractCommand {
    ...
    public final void BaseCoreGenericHandler(@NotNull LiteBansModule_83 ch2, @NotNull SilentHandler dZ2, @NotNull NoneHandler_2 cz2) {
        ...
        if (cz3.i() != null) {
            ...
            if (list.isEmpty()) {
                list = cz3.g().LiteBansModule_241().AsyncBackgroundTask_5();
            }
        }
        ...
        while (iterator.hasNext()) {
            ...
            ((ConfigService)((MessageHandler)targetObj).LiteBansModule_241().BaseCoreGenericHandler(ConfigService.class)).BaseCoreGenericHandler(10, (Object)string2);
    ...
    public final void BaseCoreGenericHandler(@NotNull NoneHandler_2 cz2) {
        ...
        DatabaseService gn_02 = ((ConfigService)messageHandler.LiteBansModule_241().BaseCoreGenericHandler(ConfigService.class)).z().c();
        ...
        if (((ConfigService)fg_03.LiteBansModule_241().BaseCoreGenericHandler(ConfigService.class)).AsyncBackgroundTask_21().BaseCoreGenericHandler() == null) {
    ...
    static {
        UnbanCommand.BaseCoreGenericHandler();
    }
}
