...
implements LiteBansModule_88 {
    ...
    public final void BaseCoreGenericHandler(@NotNull AsyncPlayerChatEvent asyncPlayerChatEvent) {
        try {
            ...
            if (!pluginWrapper.isEnabled() || plugin.AsyncBackgroundTask_21()) {
            ...
            String string2;
{
    ...
    static /* synthetic */ void BaseCoreGenericHandler(PlayerChatListener_2 hE2, Object targetObj, CommandSenderWrapper sender, SilentHandler dZ2, int n, Object contextObj) {
        if ((n & 4) != 0) {
            dZ2 = null;
        }
        hE2.BaseCoreGenericHandler(targetObj, sender, dZ2);
    }
