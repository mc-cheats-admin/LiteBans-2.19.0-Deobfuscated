...
extends Entry {
    ...
    public int getTemplateID() {
        return LiteBansModule_284.BaseCoreGenericHandler(this.getTemplate()) & 0xFF;
    }
    ...
    public String getTemplateName() {
        ...
        BanHandler a_2 = BanHandler.LiteBansModule_403.BaseCoreGenericHandler(this.getType());
        ObjectUtilities.BaseCoreGenericHandler(a_2);
        Object targetObj = fu2.BaseCoreGenericHandler(a_2, this.getTemplateID());
        if (targetObj == null || (targetObj = ((LiteBansModule_65)targetObj).g()) == null) {
            targetObj = "";
        }
        return targetObj;
    }
    ...
    static {
        LiteBansModule_360.BaseCoreGenericHandler();
    }
}
