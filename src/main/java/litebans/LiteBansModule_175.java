...
public final class LiteBansModule_175 {
    ...
    private final long LiteBansModule_195;
        public LiteBansModule_175(@NotNull String string, @NotNull BanHandler a_2, @NotNull Map map, @NotNull Map map2, @NotNull List list, long l3) {
        this.c = string;
    ...
    public final List LiteBansModule_195() {
        return this.g;
    }
    ...
    public final LiteBansModule_67 BaseCoreGenericHandler(int n) {
        return n >= this.g.size() ? (LiteBansModule_67)CollectionUtilities.BaseCoreGenericHandler(this.g) : (n < 0 ? (LiteBansModule_67)CollectionUtilities.LiteBansModule_31(this.g) : (LiteBansModule_67)this.g.get(n));
    }

    public String toString() {
        return "TemplateGroup(name=" + this.c + ", type=" + this.LiteBansModule_31 + ", weights=" + this.plugin + ", templates=" + this.AsyncBackgroundTask_5 + ", ladder=" + this.g + ", ladderExpiry=" + this.LiteBansModule_195 + ')';
    }
    ...
    public int hashCode() {
        ...
        n = n * 31 + Long.hashCode(this.LiteBansModule_195);
        return n;
    }
    ...
    public boolean equals(@Nullable Object targetObj) {
        ...
        if (!(targetObj instanceof LiteBansModule_175)) {
            return false;
        }
        LiteBansModule_175 eM2 = (LiteBansModule_175)targetObj;
        ...
        return this.LiteBansModule_195 == eM2.LiteBansModule_195;
    }
