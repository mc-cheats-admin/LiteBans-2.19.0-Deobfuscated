...
public final class LiteBansModule_114 {
    ...
    public LiteBansModule_114(@Nullable String string, @Nullable String string2, @Nullable String string3, @Nullable String string4, @Nullable String string5, @Nullable CommandSenderWrapper sender, @Nullable String string6) {
        ...
        this.LiteBansModule_195 = string6;
        String string7 = this.plugin;
        this.plugin = string7 != null ? StringUtilities.BaseCoreGenericHandler(string7, '*', '%', false, 4, null) : null;
    }

    public /* synthetic */ LiteBansModule_114(String string, String string2, String string3, String string4, String string5, CommandSenderWrapper sender, String string6, int n, LiteBansModule_14 aJ2) {
        if ((n & 2) != 0) {
            string2 = string;
        }
        if ((n & 4) != 0) {
    ...
    public final boolean LiteBansModule_31() {
        ...
        if (string != null) {
            ...
            flag = LiteBansModule_346.BaseCoreGenericHandler.i(string2);
        } else {
            flag = false;
        }
        return flag;
