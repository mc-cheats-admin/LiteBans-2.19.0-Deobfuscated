...
implements CharSequence {
    ...
    public static final MessageKey HexEncodingHelper = new MessageKey("MUTE_USAGE", 77, LiteBansModule_96, "usage", (CharSequence)(BlackHandler.c + "Usage: $command [-AsyncBackgroundTask_21] <player> [time spec] [reason]"));
