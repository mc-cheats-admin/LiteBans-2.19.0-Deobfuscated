...
implements CharSequence {
    ...
    public static final MessageKey LiteBansModule_97 = new MessageKey("C_MUTE", 2, LiteBansModule_21, "mute");
    ...
    public static final MessageKey LiteBansModule_83 = new MessageKey("C_HISTORY", 5, LiteBansModule_21, "history");
    public static final MessageKey LiteBansModule_133 = new MessageKey("C_STAFFHISTORY", 6, LiteBansModule_21, "staffhistory");
    public static final MessageKey LiteBansModule_108 = new MessageKey("C_WARNINGS", 7, LiteBansModule_21, "warnings");
    public static final MessageKey LiteBansModule_72 = new MessageKey("C_PRUNEHISTORY", 8, LiteBansModule_21, "prunehistory");
    ...
    public static final MessageKey LiteBansModule_141 = new MessageKey("C_IPREPORT", 14, LiteBansModule_21, "ipreport");
    public static final MessageKey LiteBansModule_123 = new MessageKey("C_CHECKBAN", 15, LiteBansModule_21, "checkban");
    ...
    public static final MessageKey LiteBansModule = new MessageKey("DATE_FORMAT", 23, "time_format", (CharSequence)"yyyy-MM-LiteBansModule_119");
    ...
    public static final MessageKey LiteBansModule_119 = new MessageKey("DEFAULT_MUTE_REASON", 25, "default_mute_reason", (CharSequence)"Spamming");
    ...
    public static final MessageKey LiteBansModule_67 = new MessageKey("BANNED_MESSAGE_BASE", 29, "banned_message_base", (CharSequence)(BlackHandler.c + "You are banned from this server!" + BlackHandler.Utf8Handler_2 + "\n\nBanned on: $dateStart\nBanned LiteBansModule_61: $executor\nReason: $reason" + BlackHandler.Utf8Handler_2 + '\n'));
    ...
    public static final MessageKey LiteBansModule_117 = new MessageKey("BANNED_MESSAGE_GEOIP", 33, "banned_message_geoip_blacklist", (CharSequence)(BlackHandler.c + "You are banned from this server!" + BlackHandler.Utf8Handler_2 + "\n\nYour location is blacklisted: $geoip"));
    ...
    public static final MessageKey LiteBansModule_241 = new MessageKey("NOTIFY_BANNED_PLAYER_JOIN", 41, bd, "banned_player_join", (CharSequence)(BlackHandler.c + "$player" + BlackHandler.Utf8Handler_2 + " tried to join, but is banned ($duration)!"));
    ...
    public static final MessageKey LiteBansModule_435 = new MessageKey("ERROR_STACK_OVERFLOW", 50, "error_stack_overflow", (CharSequence)(BlackHandler.c + "Stack overflow "));
    ...
    public static final MessageKey LiteBansModule_68 = new MessageKey("ERROR_INTERNAL", 53, "internal_error", (CharSequence)(BlackHandler.c + "An internal error occurred while attempting to perform this "));
    ...
    public static final MessageKey LiteBansModule_84 = new MessageKey("BAN_SILENT_PREFIX", 56, BaseCoreGenericHandler, "silent_prefix", (CharSequence)(BlackHandler.Utf8Handler_2 + "[" + BlackHandler.BroadcastService + "Silent" + BlackHandler.Utf8Handler_2 + "] "));
    public static final MessageKey LiteBansModule_78 = new MessageKey("BAN_BROADCAST", 57, BaseCoreGenericHandler, "broadcast_ban", (CharSequence)(BlackHandler.c("$executor ") + BlackHandler.Utf8Handler_2 + "banned " + BlackHandler.i + "$playerDisplayName " + BlackHandler.Utf8Handler_2 + "for '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + '\''));
    ...
    public static final MessageKey LiteBansModule_34 = new MessageKey("BAN_PREVIOUS_BAN_EXISTING", 62, BaseCoreGenericHandler, "previous_ban_existing", (CharSequence)BlackHandler.LiteBansModule_195("$playerName is already banned, and you do not have permission to replace existing "));
    public static final MessageKey SQLiteDriverHandler_2 = new MessageKey("BAN_ERROR_UNBAN_FAIL", 63, BaseCoreGenericHandler, "unban_fail", (CharSequence)BlackHandler.LiteBansModule_195("Target is not banned!"));
    public static final MessageKey ai = new MessageKey("BAN_ERROR_NO_OVERRIDE", 64, BaseCoreGenericHandler, "no_override", (CharSequence)BlackHandler.LiteBansModule_195("Player is already banned!"));
    public static final MessageKey LiteBansModule_118 = new MessageKey("BAN_ALTS_GUARDRAIL_DISCLAIMER", 65, BaseCoreGenericHandler, "alts_guardrail_disclaimer", (CharSequence)(BlackHandler.AsyncBackgroundTask_5("// WARNING WARNING WARNING WARNING WARNING //\n") + BlackHandler.g("Automatically banning accounts can result InitializerHandler_3 unintended and unexpected outcomes, such CommandExitException causing innocent players to be banned automatically.\n") + BlackHandler.g("If you want to enable this feature, please check and ensure the following:\n") + BlackHandler.LiteBansModule_195("1) Your players are not joining from BaseCoreGenericHandler limited range of IP addresses belonging to one specific host, such CommandExitException BaseCoreGenericHandler DDoS protection service forwarding players to your server.\n") + BlackHandler.LiteBansModule_195("2) All of your servers have IP forwarding set up correctly (please consult BungeeCord or Velocity documentation to set up IP forwarding, if you have not done so).\n") + BlackHandler.LiteBansModule_195("3) None of your user accounts are being randomly associated when checking /alts or /ipreport to view linked accounts on the same IP.\n") + BlackHandler.LiteBansModule_195("4) If you have HikariDataSource offline-mode network or permit non-premium users to join, please add your authentication or lobby server to ignored_iphistory_servers to prevent falsely associated accounts (since anyone can join any account).\n") + BlackHandler.AsyncBackgroundTask_5("// WARNING WARNING WARNING WARNING WARNING //\n") + BlackHandler.c("If you acknowledge and accept this disclaimer, please type " + BlackHandler.BaseCoreGenericHandler("litebans accept") + BlackHandler.c(" to enable automatic "))));
    public static final MessageKey aa = new MessageKey("BAN_ALTS_GUARDRAIL_BAN_SELF", 66, BaseCoreGenericHandler, "alts_guardrail_ban_self", (CharSequence)BlackHandler.LiteBansModule_195("Error: Banning associated accounts for $playerName would also ban your account!\nNo additional players will be "));
    ...
    public static final MessageKey LiteBansModule_106 = new MessageKey("BAN_EXEMPT", 68, BaseCoreGenericHandler, "exempt", (CharSequence)BlackHandler.LiteBansModule_195("You can'AsyncBackgroundTask_22 ban $player!"));
    public static final MessageKey LiteBansModule_36 = new MessageKey("BAN_COOLDOWN", 69, BaseCoreGenericHandler, "cooldown", (CharSequence)BlackHandler.LiteBansModule_195("You need to wait " + BlackHandler.AsyncBackgroundTask_5("$duration") + BlackHandler.LiteBansModule_195(" before you can use this command ")));
    ...
    public static final MessageKey LiteBansModule_66 = new MessageKey("MUTE_USAGE", 77, LiteBansModule_97, "usage", (CharSequence)(BlackHandler.c + "Usage: $command [-AsyncBackgroundTask_21] <player> [time spec] [reason]"));
    public static final MessageKey ah = new MessageKey("MUTE_EXAMPLE", 78, LiteBansModule_97, "example", (CharSequence)(BlackHandler.c + "Example: $command Player 7d [reason]"));
    public static final MessageKey ce = new MessageKey("MUTE_BROADCAST", 79, LiteBansModule_97, "broadcast", (CharSequence)(BlackHandler.i + "$executor " + BlackHandler.Utf8Handler_2 + "muted " + BlackHandler.i + "$playerDisplayName " + BlackHandler.Utf8Handler_2 + "for '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey dx = new MessageKey("MUTE_BROADCAST_TEMP", 80, LiteBansModule_97, "broadcast_tempmute", (CharSequence)(BlackHandler.i + "$executor " + BlackHandler.Utf8Handler_2 + "tempmuted " + BlackHandler.i + "$playerDisplayName " + BlackHandler.Utf8Handler_2 + "for $tempDuration for '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey m = new MessageKey("MUTE_BROADCAST_IP", 81, LiteBansModule_97, "broadcast_ip_mute", (CharSequence)(BlackHandler.i + "$executor " + BlackHandler.Utf8Handler_2 + "IP-muted " + BlackHandler.i + "$playerDisplayName " + BlackHandler.Utf8Handler_2 + "for '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey dq = new MessageKey("MUTE_BROADCAST_TEMP_IP", 82, LiteBansModule_97, "broadcast_temp_ip_mute", (CharSequence)(BlackHandler.i + "$executor " + BlackHandler.Utf8Handler_2 + "temp IP-muted " + BlackHandler.i + "$playerDisplayName " + BlackHandler.Utf8Handler_2 + "for $tempDuration for '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey e = new MessageKey("MUTE_MESSAGE", 83, LiteBansModule_97, "message", (CharSequence)(BlackHandler.F + "You have been muted LiteBansModule_61 $executor" + BlackHandler.F + " for " + BlackHandler.c + '\'' + BlackHandler.F + "$reason" + BlackHandler.c + "'" + BlackHandler.F + ".\n" + BlackHandler.F + "This mute will expire InitializerHandler_3 $"));
    public static final MessageKey dK = new MessageKey("MUTE_MESSAGE_PERMANENT", 84, LiteBansModule_97, "message_permanent", (CharSequence)(BlackHandler.F + "You have been permanently muted LiteBansModule_61 $executor" + BlackHandler.F + " for " + BlackHandler.c + '\'' + BlackHandler.F + "$reason" + BlackHandler.c + "'" + BlackHandler.F + ".\n" + BlackHandler.F + "This mute will not "));
    public static final MessageKey di = new MessageKey("MUTE_ERROR_UNMUTE_FAIL", 85, LiteBansModule_97, "unmute_fail", (CharSequence)(BlackHandler.c + "Target is not muted!"));
    public static final MessageKey LiteBansModule_5 = new MessageKey("MUTE_ERROR_NO_OVERRIDE", 86, LiteBansModule_97, "no_override", (CharSequence)(BlackHandler.c + "Player is already muted!"));
    public static final MessageKey ServerSyncService = new MessageKey("MUTE_PREVIOUS_MUTE_REMOVED", 87, LiteBansModule_97, "previous_mute_removed", (CharSequence)(BlackHandler.i + "Previous mute for $playerName "));
    public static final MessageKey SQLiteDriverHandler = new MessageKey("MUTE_PREVIOUS_MUTE_EXISTING", 88, LiteBansModule_97, "previous_mute_existing", (CharSequence)(BlackHandler.c + "$playerName is already muted, and you do not have permission to replace existing "));
    public static final MessageKey cY = new MessageKey("MUTE_EXEMPT", 89, LiteBansModule_97, "exempt", (CharSequence)(BlackHandler.c + "You can'AsyncBackgroundTask_22 mute $player!"));
    public static final MessageKey LiteBansModule_56 = new MessageKey("MUTE_NOTIFY", 90, LiteBansModule_97, "notification", (CharSequence)(BlackHandler.c + "$playerDisplayName tried to speak, but is "));
    public static final MessageKey LiteBansModule_135 = new MessageKey("MUTE_DISABLED", 91, LiteBansModule_97, "error_not_enabled", (CharSequence)(BlackHandler.c + "Muting is not enabled InitializerHandler_3 the configuration!"));
    public static final MessageKey dA = new MessageKey("MUTE_RESPONSE", 92, LiteBansModule_97, "response", (CharSequence)"");
    public static final MessageKey LiteBansModule_71 = new MessageKey("UNMUTE_USAGE", 93, LiteBansModule_97, "unmute_usage", (CharSequence)(BlackHandler.c + "Usage: $command <player>"));
    public static final MessageKey PlayerproviderHandler = new MessageKey("UNMUTE_BROADCAST", 94, LiteBansModule_97, "broadcast_unmute", (CharSequence)(BlackHandler.i + "$executor " + BlackHandler.Utf8Handler_2 + "unmuted " + BlackHandler.i + "$playerDisplayName " + BlackHandler.Utf8Handler_2 + "for '" + BlackHandler.i + "$removalReason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey LiteBansModule_103 = new MessageKey("WARN_USAGE", 95, LiteBansModule_9, "usage", (CharSequence)(BlackHandler.c + "Usage: $command [-AsyncBackgroundTask_21] <player> [reason]"));
    public static final MessageKey NullHandler = new MessageKey("WARN_EXAMPLE", 96, LiteBansModule_9, "example", (CharSequence)"");
    public static final MessageKey LiteBansModule_105 = new MessageKey("WARN_BROADCAST", 97, LiteBansModule_9, "broadcast", (CharSequence)(BlackHandler.i + "$executor " + BlackHandler.Utf8Handler_2 + "warned " + BlackHandler.i + "$playerDisplayName " + BlackHandler.Utf8Handler_2 + "for '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + '\''));
    ...
    public static final MessageKey LiteBansModule_70 = new MessageKey("WARN_UNWARN_SUCCESS", 100, LiteBansModule_9, "unwarn_response", (CharSequence)(BlackHandler.i + "Last warning removed for $"));
    ...
    public static final MessageKey LiteBansModule_100 = new MessageKey("KICK_RESPONSE", 111, bk, "response", (CharSequence)(BlackHandler.m + "$playerDisplayName has been "));
    public static final MessageKey LiteBansModule_79 = new MessageKey("KICK_BROADCAST", 112, bk, "broadcast", (CharSequence)(BlackHandler.i + "$playerDisplayName" + BlackHandler.Utf8Handler_2 + " was kicked LiteBansModule_61 " + BlackHandler.i + "$executor" + BlackHandler.Utf8Handler_2 + " for '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + "' + "));
    ...
    public static final MessageKey LiteBansModule_403 = new MessageKey("HISTORY_USAGE", 115, LiteBansModule_83, "usage", (CharSequence)(BlackHandler.c + "$command <player> [entries=10]"));
    public static final MessageKey GnuSparseMapHandler = new MessageKey("HISTORY_START", 116, LiteBansModule_83, "start", (CharSequence)(BlackHandler.i + "History for $target (Limit: $limit):"));
    public static final MessageKey B = new MessageKey("HISTORY_BAN", 117, LiteBansModule_83, "ban_entry", (CharSequence)(BlackHandler.i + " -- [" + BlackHandler.Utf8Handler_2 + "$timeSince ago" + BlackHandler.i + "] --" + BlackHandler.Utf8Handler_2 + "\n" + BlackHandler.Utf8Handler_2 + " $name was " + BlackHandler.c + "banned " + BlackHandler.Utf8Handler_2 + "LiteBansModule_61 $executor: '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey ContinueEvictHandler = new MessageKey("HISTORY_MUTE", 118, LiteBansModule_83, "mute_entry", (CharSequence)(BlackHandler.i + " -- [" + BlackHandler.Utf8Handler_2 + "$timeSince ago" + BlackHandler.i + "] --" + BlackHandler.Utf8Handler_2 + "\n" + BlackHandler.Utf8Handler_2 + " $name was " + BlackHandler.BroadcastService + "muted " + BlackHandler.Utf8Handler_2 + "LiteBansModule_61 $executor: '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey StringUtilities = new MessageKey("HISTORY_WARN", 119, LiteBansModule_83, "warn_entry", (CharSequence)(BlackHandler.i + " -- [" + BlackHandler.Utf8Handler_2 + "$timeSince ago" + BlackHandler.i + "] --" + BlackHandler.Utf8Handler_2 + "\n" + BlackHandler.Utf8Handler_2 + " $name was " + BlackHandler.m + "warned " + BlackHandler.Utf8Handler_2 + "LiteBansModule_61 $executor: '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey cx = new MessageKey("HISTORY_KICK", 120, LiteBansModule_83, "kick_entry", (CharSequence)(BlackHandler.i + " -- [" + BlackHandler.Utf8Handler_2 + "$timeSince ago" + BlackHandler.i + "] --" + BlackHandler.Utf8Handler_2 + "\n" + BlackHandler.Utf8Handler_2 + " $name was " + BlackHandler.ServerSyncService + "kicked " + BlackHandler.Utf8Handler_2 + "LiteBansModule_61 $executor: '" + BlackHandler.i + "$reason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey LiteBansModule_94 = new MessageKey("HISTORY_UNBAN", 121, LiteBansModule_83, "unban_entry", (CharSequence)("\n " + BlackHandler.Utf8Handler_2 + "$name was " + BlackHandler.BroadcastService + "unbanned " + BlackHandler.Utf8Handler_2 + "LiteBansModule_61 $executor: '" + BlackHandler.BroadcastService + "$removalReason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey V = new MessageKey("HISTORY_UNMUTE", 122, LiteBansModule_83, "unmute_entry", (CharSequence)("\n " + BlackHandler.Utf8Handler_2 + "$name was " + BlackHandler.BroadcastService + "unmuted " + BlackHandler.Utf8Handler_2 + "LiteBansModule_61 $executor: '" + BlackHandler.BroadcastService + "$removalReason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey aG = new MessageKey("HISTORY_UNWARN", 123, LiteBansModule_83, "unwarn_entry", (CharSequence)("\n " + BlackHandler.Utf8Handler_2 + "$name was " + BlackHandler.BroadcastService + "unwarned " + BlackHandler.Utf8Handler_2 + "LiteBansModule_61 $executor: '" + BlackHandler.BroadcastService + "$removalReason" + BlackHandler.Utf8Handler_2 + '\''));
    public static final MessageKey LiteBansModule_90 = new MessageKey("HISTORY_SUFFIX_ACTIVE", 124, LiteBansModule_83, "active_suffix", (CharSequence)(BlackHandler.Utf8Handler_2 + " [" + BlackHandler.c + "Active" + BlackHandler.Utf8Handler_2 + ']'));
    public static final MessageKey MessageKey = new MessageKey("HISTORY_SUFFIX_ACTIVE_TEMP", 125, LiteBansModule_83, "active_suffix_temp", (CharSequence)(BlackHandler.Utf8Handler_2 + " [" + BlackHandler.c + "Active" + BlackHandler.Utf8Handler_2 + "]\n" + BlackHandler.Utf8Handler_2 + "Expires InitializerHandler_3 $"));
    public static final MessageKey dm = new MessageKey("HISTORY_SUFFIX_EXPIRED", 126, LiteBansModule_83, "expired_suffix", (CharSequence)(BlackHandler.Utf8Handler_2 + " [" + BlackHandler.g + "Expired" + BlackHandler.Utf8Handler_2 + ']'));
    public static final MessageKey LiteBansException = new MessageKey("HISTORY_ERROR_NO_LOGINRECORD", 127, LiteBansModule_83, "error_no_loginrecord", (CharSequence)(BlackHandler.c + "User has not joined "));
    public static final MessageKey LiteBansModule_17 = new MessageKey("HISTORY_ERROR_NO_USER", 128, LiteBansModule_83, "error_no_user", (CharSequence)(BlackHandler.c + "User not "));
    public static final MessageKey LiteBansModule_38 = new MessageKey("WARNINGS_USAGE", 129, LiteBansModule_108, "usage", (CharSequence)(BlackHandler.c + "$command <player>"));
    public static final MessageKey bc = new MessageKey("WARNINGS_START", 130, LiteBansModule_108, "start", (CharSequence)(BlackHandler.i + "Active warnings for $target:"));
    public static final MessageKey NullHandler_8 = new MessageKey("PRUNEHISTORY_USAGE", 131, LiteBansModule_72, "usage", (CharSequence)(BlackHandler.c + "$command <player> [duration]"));
    public static final MessageKey LiteBansModule_15 = new MessageKey("PRUNEHISTORY_MESSAGE", 132, LiteBansModule_72, "message", (CharSequence)(BlackHandler.i + "History "));
    public static final MessageKey PoolEntry = new MessageKey("STAFFHISTORY_USAGE", 133, LiteBansModule_133, "usage", (CharSequence)(BlackHandler.c + "$command <player> [entries=10]"));
    public static final MessageKey ax = new MessageKey("STAFFHISTORY_START", 134, LiteBansModule_133, "start", (CharSequence)(BlackHandler.i + "Staff history for $target (Limit: $limit):"));
    ...
    public static final MessageKey LiteBansModule_69 = new MessageKey("IPHISTORY_USAGE", 138, bZ, "usage", (CharSequence)(BlackHandler.c + "$command <player> [entries=10]"));
    ...
    public static final MessageKey LiteBansModule_32 = new MessageKey("IPREPORT_START", 156, LiteBansModule_141, "start", (CharSequence)(BlackHandler.Utf8Handler_2 + "Scanning " + BlackHandler.i + "$num" + BlackHandler.Utf8Handler_2 + " online players. + " + '[' + BlackHandler.i + "Online" + BlackHandler.Utf8Handler_2 + "] [" + BlackHandler.BroadcastService + "Offline" + BlackHandler.Utf8Handler_2 + "] [" + BlackHandler.c + "Banned" + BlackHandler.Utf8Handler_2 + ']'));
    public static final MessageKey LiteBansModule_3 = new MessageKey("IPREPORT_ENTRY", 157, LiteBansModule_141, "entry", (CharSequence)(BlackHandler.Utf8Handler_2 + "$player" + BlackHandler.i + ": $result"));
    public static final MessageKey TapeHandler = new MessageKey("CHECKBAN_USAGE", 158, LiteBansModule_123, "usage", (CharSequence)(BlackHandler.c + "$command <player>"));
    public static final MessageKey LiteBansModule_13 = new MessageKey("CHECKBAN_NO_BAN", 159, LiteBansModule_123, "no_ban", (CharSequence)(BlackHandler.c + "Target is not banned!"));
    public static final MessageKey HoverTextFormatter = new MessageKey("CHECKBAN_BANNED", 160, LiteBansModule_123, "banned", (CharSequence)(BlackHandler.i + "Target " + BlackHandler.Utf8Handler_2 + '[' + BlackHandler.i + "$target" + BlackHandler.Utf8Handler_2 + ']' + BlackHandler.i + " is banned:\n" + BlackHandler.i + "Banned LiteBansModule_61: $executor\n" + BlackHandler.i + "Reason: $reason" + BlackHandler.i + "\n" + BlackHandler.i + "Banned on: $dateStart\n" + BlackHandler.i + "Banned until: $dateEnd ($duration)\n&aBanned on server &6&BaseCoreGenericHandler$serverOrigin&BaseCoreGenericHandler, server scope: &6$serverScope\n" + BlackHandler.i + "IP ban: $ipban, silent: $silent, permanent: $permanent"));
    ...
    public static final MessageKey Utf8Handler = new MessageKey("CHECKMUTE_MUTED", 163, LiteBansModule_61, "muted", (CharSequence)(BlackHandler.i + "Target &LiteBansModule_195[&BaseCoreGenericHandler$target&LiteBansModule_195]&BaseCoreGenericHandler is muted:\n&aMuted LiteBansModule_61: $executor\n&aReason: $reason&r\n&aMuted on: $dateStart\n&aMuted until: $dateEnd ($duration)\n&aMuted on server &6$serverOrigin&BaseCoreGenericHandler, server scope: &6$serverScope\n&aIP mute: $ipban, silent: $silent, permanent: $permanent"));
    ...
    public static final MessageKey SelectorHandler = new MessageKey("CHECKWARN_WARNED", 166, EventsHandler, "warned", (CharSequence)(BlackHandler.i + "Target &LiteBansModule_195[&BaseCoreGenericHandler$target&LiteBansModule_195]&BaseCoreGenericHandler is warned:\n&aWarned LiteBansModule_61: $executor\n&aReason: $reason&r\n&aWarned on: $dateStart\n&aWarned until: $dateEnd ($duration)\n&aWarned on server &6$serverOrigin&BaseCoreGenericHandler, server scope: &6$serverScope\n&aIP warning: $ipban, silent: $silent, permanent: $permanent"));
    ...
    public static final MessageKey LiteBansModule_142 = new MessageKey("LOCKDOWN_KICK_MESSAGE_GLOBAL", 178, BanHandler_5, "kick_message_global", (CharSequence)"Network lockdown active, try again later.\\nReason: $reason");
    ...
    public static final MessageKey aO = new MessageKey("IMPORT_START", 190, i, "import_start", (CharSequence)(BlackHandler.i + "Importing from $LiteBansModule_117, this might take BaseCoreGenericHandler while.. + "));
    ...
    public static final MessageKey LiteBansModule_88 = new MessageKey("IMPORT_FINISH_LITEBANS", 192, i, "import_finish_litebans", (CharSequence)(BlackHandler.i + "Import finished successfully. Added $amount entries to the "));
    ...
    public static final MessageKey LiteBansModule_74 = new MessageKey("ALLOW_REMOVED", 197, i, "allow_removed", (CharSequence)(BlackHandler.ServerSyncService + "Player " + BlackHandler.m + "$playerName" + BlackHandler.ServerSyncService + " has been " + BlackHandler.c + "removed from the allow list" + BlackHandler.ServerSyncService + " + "));
    ...
    public static final MessageKey LiteBansModule_76 = new MessageKey("ALLOW_ERROR_ADD", 200, i, "allow_error_add", (CharSequence)(BlackHandler.c + "Error: $playerName is already allowed to join the "));
    ...
    public static final MessageKey LiteBansModule_126 = new MessageKey("DAY", 213, TempHandler, "day", (CharSequence)"day");
    ...
    public static final MessageKey LiteBansModule_110 = new MessageKey("WEB_MUTE_COLOR", 244, LiteBansModule_18, "color", (CharSequence)"#BB9000");
    ...
    public static final MessageKey LiteBansModule_195 = new MessageKey("WEB_MUTE_FIELDS", 246, LiteBansModule_18, "fields", (CharSequence)"");
    public static final MessageKey LiteBansModule_128 = new MessageKey("WEB_MUTE_THUMB", 247, LiteBansModule_18, "thumbnail", (CharSequence)"");
    ...
    public static final MessageKey LiteBansModule_81 = new MessageKey("WEB_WARN_FIELDS", 258, aM, "fields", (CharSequence)"");
    public static final MessageKey LiteBansModule_432 = new MessageKey("WEB_WARN_THUMB", 259, aM, "thumbnail", (CharSequence)"");
    ...
    public static final MessageKey LiteBansModule_92 = new MessageKey("WEB_KICK_COLOR", 268, z, "color", (CharSequence)"#999900");
    ...
    public static final MessageKey LiteBansModule_101 = new MessageKey("WEB_KICK_FIELDS", 270, z, "fields", (CharSequence)"");
     ...
     */
    private MessageKey() {
        this((String)var1_-1, (int)var2_-1, (MessageKey)v1, (String)v2, null);
        void v2;
        void v1;
        void var2_-1;
        void var1_-1;
    ...
    private MessageKey(@Nullable CharSequence charSequence) {
        this((String)var1_-1, (int)var2_-1, ((MessageKey)charSequence).BaseCoreGenericHandler() + '.' + (String)v2, (CharSequence)v3);
        void v3;
        void v2;
        void var2_-1;
        void var1_-1;
     ...
     */
    private MessageKey() {
        this((String)var1_-1, (int)var2_-1, (String)v1);
        void v2;
        void v1;
        void var2_-1;
        void var1_-1;
        this.plugin((CharSequence)v2);
    }
    ...
    public static String BaseCoreGenericHandler(Object targetObj, boolean flag, boolean flag2) {
        ...
        if (targetObj instanceof Character) {
            return new String(new char[]{((Character)targetObj).charValue()});
        }
        if (flag) {
            if (flag2) {
    ...
    private static final /* synthetic */ MessageKey[] LiteBansModule_31() {
        return new MessageKey[]{LiteBansModule_21, BaseCoreGenericHandler, LiteBansModule_97, LiteBansModule_9, bk, LiteBansModule_83, LiteBansModule_133, LiteBansModule_108, LiteBansModule_72, bH, W, bZ, bJ, cN, LiteBansModule_141, LiteBansModule_123, LiteBansModule_61, EventsHandler, dg, BanHandler_5, LiteBansModule_12, i, LiteBansModule_50, LiteBansModule, Utf8Handler_2, LiteBansModule_119, df, LockdownService, cu, LiteBansModule_67, bS, F, CommandThrottleService, LiteBansModule_117, AsyncBackgroundTask_5, aj, ak, AsyncBackgroundTask, du, az, bd, LiteBansModule_241, PlayerJoinListener, cZ, cm, cl, be, ServerEventListener, aN, aL, LiteBansModule_435, LiteBansModule_31, g, LiteBansModule_68, cC, LockdownCommandHandler, LiteBansModule_84, LiteBansModule_78, cp, LiteBansModule_6, LiteBansModule_2, dB, LiteBansModule_34, SQLiteDriverHandler_2, ai, LiteBansModule_118, aa, U, LiteBansModule_106, LiteBansModule_36, D, cj, af, SecHandler, L, cO, LiteBansModule_14, LiteBansModule_66, ah, ce, dx, m, dq, e, dK, di, LiteBansModule_5, ServerSyncService, SQLiteDriverHandler, cY, LiteBansModule_56, LiteBansModule_135, dA, LiteBansModule_71, PlayerproviderHandler, LiteBansModule_103, NullHandler, LiteBansModule_105, Y, UsageHandler, LiteBansModule_70, BuilderactionHandler, aS, CommandExitException, K, ad, LiteBansModule_37, dL, dz, bf, InitializerHandler, LiteBansModule_100, LiteBansModule_79, LiteBansModule_4, T, LiteBansModule_403, GnuSparseMapHandler, B, ContinueEvictHandler, StringUtilities, cx, LiteBansModule_94, V, aG, LiteBansModule_90, MessageKey, dm, LiteBansException, LiteBansModule_17, LiteBansModule_38, bc, NullHandler_8, LiteBansModule_15, PoolEntry, ax, dE, LiteBansModule_64, LiteBansModule_35, LiteBansModule_69, ProxyResultSet, ac, PlayerQuitListener, dH, ReaderHandler, SortHandler, LiteBansModule_29, BanHandler_4, P, HikariPool, PoolBase, ProxyConnection, BroadcastService, n, DatabaseMonitorService, cd, PunishmentTableService, LiteBansModule_32, LiteBansModule_3, TapeHandler, LiteBansModule_13, HoverTextFormatter, LiteBansModule_27, LiteBansModule_23, Utf8Handler, BanHandler_2, AsyncBackgroundTask_8, SelectorHandler, HikariDataSource, bI, cq, AsyncBackgroundTask_21, cF, ck, CommandExecutionTask, cG, bV, X, LiteBansModule_24, LiteBansModule_142, c, aW, ar, bM, ProxyPreparedStatement, PropertyHandler, aV, ValueHandler, LiteBansModule_65, LiteBansModule_25, LiteBansException_2, aO, ValueHandler_2, LiteBansModule_88, LiteBansModule_40, GeoIPLookupService, flag, ElementHandler, LiteBansModule_74, bq, bO, LiteBansModule_76, ExceptionHandler, dj, LiteBansModule_39, TempHandler, HikariConfig, LiteBansModule_60, AsyncBackgroundTask_6, q, LiteBansModule_10, aT, ElementsHandler_3, aU, LiteBansModule_126, aq, cH, SetHandler, r, cB, dC, bu, InputHandler, S, bG, LiteBansModule_7, ay, ap, OutHandler, O, cw, bR, bp, LiteBansModule_45, H, LiteBansModule_33, bB, cv, BanHandler, LiteBansModule_44, InitHandler, ProxyStatement, A, LiteBansModule_18, ab, LiteBansModule_110, ba, LiteBansModule_195, LiteBansModule_128, bw, aE, J, cT, cS, NanHandler, aM, LiteBansModule_43, dD, bY, LiteBansModule_81, LiteBansModule_432, dn, NoneHandler_2, ci, ElementsHandler, PunishmentService, AsyncBackgroundTask_7, z, bx, LiteBansModule_92, dt, LiteBansModule_101, bn, LitebansNotifyHandler, bt, ca, HistoryCleanupTask};
    }
