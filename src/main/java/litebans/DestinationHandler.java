...
extends DefaultvalueHandler_4 {
    public static final List BaseCoreGenericHandler(@NotNull Object[] objectArray) {
        ...
        return LiteBansModule_126.BaseCoreGenericHandler(objectArray);
    }
    ...
    public static /* synthetic */ Object[] BaseCoreGenericHandler(Object[] objectArray, Object[] objectArray2, int n, int n2, int n3, int n4, Object object) {
        if ((n4 & 2) != 0) {
            n = 0;
        }
        if ((n4 & 4) != 0) {
