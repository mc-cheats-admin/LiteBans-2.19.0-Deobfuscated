...
implements Runnable {
    ...
    static final AsyncBackgroundTask_15 g = new LiteBansModule_330();
    ...
    AsyncBackgroundTask_15(InUseHandler kJ2) {
        ...
        this.LiteBansModule_195 = Thread.currentThread().getName();
    ...
    public void run() {
        ...
        BaseCoreGenericHandler.c("Connection leak detection triggered for %AsyncBackgroundTask_21 on thread %AsyncBackgroundTask_21, stack trace follows", new Object[]{this.e, this.LiteBansModule_195, this.AsyncBackgroundTask_5});
    }

    void BaseCoreGenericHandler() {
        this.c.cancel(false);
        if (this.LiteBansModule_31) {
            BaseCoreGenericHandler.AsyncBackgroundTask_5("Previously reported leaked connection %AsyncBackgroundTask_21 on thread %AsyncBackgroundTask_21 was returned to the pool (unleaked)", new Object[]{this.e, this.LiteBansModule_195});
        }
    }

    /* synthetic */ AsyncBackgroundTask_15(LiteBansModule_330 j22) {
        this();
    }
}
