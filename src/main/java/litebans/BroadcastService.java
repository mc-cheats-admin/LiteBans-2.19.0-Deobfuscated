...
extends PluginModule {
    ...
    private final LiteBansModule_162 m = ProxyConnection.BaseCoreGenericHandler(() -> BroadcastService.LiteBansModule_31(this));
    private final LiteBansModule_162 g = ProxyConnection.BaseCoreGenericHandler(() -> BroadcastService.BaseCoreGenericHandler(this));
    ...
    private final Set LiteBansModule_195 = Collections.newSetFromMap(new ConcurrentHashMap());
    private final LiteBansModule_162 BroadcastService = ProxyConnection.BaseCoreGenericHandler(() -> BroadcastService.c(this));
    ...
    public final CharSequence LiteBansModule_403() {
    ...
    public final Set LiteBansModule_195() {
        return this.LiteBansModule_195;
    }

    public final GeoIPLookupService_3 c() {
        LiteBansModule_162 eE2 = this.BroadcastService;
    ...
    public final GeoIPLookupService_3 BaseCoreGenericHandler(@NotNull PlatformPlugin plugin) {
        ...
        if (by2 == 0 || by2 == 3) {
            gu2 = new LiteBansModule_237(plugin);
        } else if (by2 == 1) {
    ...
    public final void BaseCoreGenericHandler(@NotNull LiteBansModule_83 ch2, @NotNull CharSequence charSequence, @NotNull BroadcastHandler ij2, @Nullable BanHandler a_2, @Nullable String string, boolean flag, boolean flag2, @Nullable CommandSenderWrapper sender) {
        this.plugin(ch2, charSequence, ij2.LiteBansModule_195(), a_2, string, flag, flag2, sender);
    }

    public static /* synthetic */ void BaseCoreGenericHandler(BroadcastService o2, LiteBansModule_83 ch2, CharSequence charSequence, BroadcastHandler ij2, BanHandler a_2, String string, boolean flag, boolean flag2, CommandSenderWrapper sender, int n, Object targetObj) {
        if ((n & 4) != 0) {
            a_2 = null;
        }
        if ((n & 8) != 0) {
    ...
    public final void BaseCoreGenericHandler(@NotNull LiteBansModule_83 ch2, @NotNull CharSequence charSequence, @Nullable String string, @Nullable BanHandler a_2, @Nullable String string2, boolean flag, boolean flag2, @Nullable CommandSenderWrapper sender) {
        DiscordWebhookClient eG2 = this.m().LiteBansModule_195();
        if (!eG2.B() && flag2) {
        ...
        if (sender != null && !sender.LiteBansModule_195()) {
            ChatFormatter.BaseCoreGenericHandler(MessageHandler.BaseCoreGenericHandler, sender, charSequence, null, 4, null);
        }
        LiteBansModule_269.BaseCoreGenericHandler.BaseCoreGenericHandler(ch2, ch2.e(), charSequence, string);
        ...
        if (string == null) {
            ...
            while (iterator.hasNext()) {
                CommandSenderWrapper senderWrapper = (CommandSenderWrapper)iterator.next();
            ...
            while (iterator.hasNext()) {
                ...
                ObjectUtilities.BaseCoreGenericHandler(senderWrapper);
                if (!this.plugin(senderWrapper, string, a_2, string2)) continue;
                ChatFormatter.BaseCoreGenericHandler(MessageHandler.BaseCoreGenericHandler, senderWrapper, charSequence, null, 4, null);
            }
        }
    }

    public static /* synthetic */ void BaseCoreGenericHandler(BroadcastService o2, LiteBansModule_83 ch2, CharSequence charSequence, String string, BanHandler a_2, String string2, boolean flag, boolean flag2, CommandSenderWrapper sender, int n, Object targetObj) {
        if ((n & 4) != 0) {
            a_2 = null;
        }
        if ((n & 8) != 0) {
    ...
    public final boolean BaseCoreGenericHandler(@NotNull CommandSenderWrapper sender, @NotNull String string, @Nullable BanHandler a_2, @Nullable String string2) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (!targetObj.e(string4)) continue;
            return true;
        }
        if (flag4) {
            return true;
        ...
        targetObj = this.i().ServerSyncService();
        String string5 = sender.LiteBansModule_241();
        if (string5 == null) {
        ...
        flag2 = false;
        if (senderWrapper.e(string6)) return true;
        if (!ObjectUtilities.BaseCoreGenericHandler((Object)v1, (Object)string2)) return false;
        senderWrapper = sender;
        String string7 = "litebans + " + string + " + " + a_2;
        flag2 = false;
        if (!senderWrapper.e(string7)) return false;
        return true;
    }

    public final boolean BaseCoreGenericHandler(@NotNull SilentHandler dZ2, @NotNull String string) {
        if (!((Collection)this.LiteBansModule_195).isEmpty() && this.LiteBansModule_195.remove(((String)(targetObj = string)).toLowerCase(Locale.ROOT))) {
            targetObj = this.plugin.HoverTextFormatter();
            this.i().BaseCoreGenericHandler(arg_0 -> BroadcastService.BaseCoreGenericHandler(dZ2, (CommandSenderWrapper)targetObj, this, arg_0));
    ...
    public final CommandSenderWrapper BaseCoreGenericHandler(@NotNull String string) {
        block1: {
            ...
            for (Object contextObj : objectArray) {
    ...
    public final CharSequence BaseCoreGenericHandler(long l3, boolean flag) {
        LiteBansModule_356 jT2 = this.plugin();
        if (l3 == -1L) {
    ...
    private final LiteBansModule_356 BaseCoreGenericHandler() {
        LiteBansModule_356 jT2 = (LiteBansModule_356)this.m().c().get();
        if (!ObjectUtilities.BaseCoreGenericHandler(jT2.LiteBansModule_31(), (Object)MessageKey.LiteBansModule.toString())) {
            this.m().c().remove();
            jT2 = (LiteBansModule_356)this.m().c().get();
        }
        LiteBansModule_356 jT3 = jT2;
    ...
    public final java.util.Date BaseCoreGenericHandler(@NotNull ResultSet resultSet, @NotNull String string, boolean flag, @Nullable String string2) {
        ...
        if (this.plugin(resultSet)) {
            try {
                ...
                date = ((SimpleDateFormat)LiteBansModule_431.LiteBansModule_31.BaseCoreGenericHandler().get()).parse(string3);
            }
            ...
            if (string4 == null) {
                string4 = this.m().LiteBansModule_195().ElementsHandler();
            }
    ...
    public final String BaseCoreGenericHandler(@NotNull LiteBansModule_83 ch2, @NotNull SilentHandler dZ2) {
        ...
        if (ObjectUtilities.BaseCoreGenericHandler((Object)string2, (Object)"[Console]") || ObjectUtilities.BaseCoreGenericHandler((Object)string2, (Object)"CONSOLE")) {
            return this.m().LiteBansModule_195().SQLiteDriverHandler();
        }
        String string3 = dZ2.q();
        if (this.m().LiteBansModule_195().SetHandler() && string3 != null) {
            return string3;
        }
        LiteBansModule_298 iA3 = iA2 = ch2.c(string2);
        return iA3 != null ? iA3.BaseCoreGenericHandler() : null;
    }

    public final long BaseCoreGenericHandler(boolean flag) {
        if (!flag && this.m().LiteBansModule_195().CommandThrottleService() || !this.m().LiteBansModule_195().z()) {
            return 0L;
        }
        Calendar calendar = Calendar.getInstance();
    ...
    public final void BaseCoreGenericHandler(@Nullable String string, @Nullable String string2, @Nullable String string3, @Nullable String string4, boolean flag) {
        ...
        String string6 = LiteBansModule_346.LiteBansModule_195(string5);
        DiscordWebhookClient eG2 = this.m().LiteBansModule_195();
        PunishmentTableService p2 = (PunishmentTableService)this.plugin.BaseCoreGenericHandler(PunishmentTableService.class);
        boolean flag2 = !this.m().PunishmentTableService() && !this.plugin.LiteBansModule_403() && !eG2.GnuSparseMapHandler();
        boolean flag3 = flag2 = flag2 || flag && this.plugin.LiteBansModule_403() && this.plugin.c();
        if (flag2) {
            String string7 = string;
            ObjectUtilities.BaseCoreGenericHandler((Object)string7);
            new LiteBansModule_222(this.plugin, string7, string6, string2).run();
        }
        if (flag) {
            return;
        }
        ...
        new LiteBansModule_213(plugin, string, string8, string2, string4).run();
    ...
    static /* synthetic */ void BaseCoreGenericHandler(BroadcastService o2, String string, String string2, int n, int n2, Object targetObj) {
        if ((n2 & 4) != 0) {
            n = 1;
        }
    ...
    public final boolean BaseCoreGenericHandler(@Nullable Object targetObj) {
        if (targetObj instanceof LiteBansModule_224) {
            return StringUtilities.BaseCoreGenericHandler((CharSequence)((LiteBansModule_224)targetObj).toString(), (CharSequence)"org.sqlite", false, 2, null);
        }
        return targetObj != null && StringUtilities.LiteBansModule_31(targetObj.getClass().getName(), "org.sqlite", false, 2, null);
    }

    public final void BaseCoreGenericHandler(@NotNull LiteBansModule_83 ch2, @NotNull NoneHandler_2 cz2) {
    ...
    public final void BaseCoreGenericHandler(@NotNull LiteBansModule_83 ch2, @NotNull SilentHandler dZ2, @Nullable String string) {
        if (ch2.e().AsyncBackgroundTask_22() == 1 && dZ2.ServerSyncService() == BanHandler.LiteBansModule_241) {
            Object targetObj = dZ2.DatabaseMonitorService();
            if (LiteBansModule_346.BaseCoreGenericHandler((String)targetObj)) {
                GeoIPLookupService_3 gu2 = this.c();
                ObjectUtilities.LiteBansModule_31(gu2, "");
                Object contextObj = targetObj = (KickOtherHandler)gu2;
                String string2 = string;
                if (string2 == null) {
                    LiteBansModule_298 iA2 = ch2.c(dZ2.DatabaseMonitorService());
                ...
                if (string4 == null) {
                    string4 = LiteBansModule_182.LiteBansModule_195.LiteBansModule_31();
                }
                ((KickOtherHandler)contextObj).BaseCoreGenericHandler(ch2, string2, uUID, string3, string4, CollectionUtilities.BaseCoreGenericHandler(dZ2));
            }
        }
    }

    public static /* synthetic */ void BaseCoreGenericHandler(BroadcastService o2, LiteBansModule_83 ch2, SilentHandler dZ2, String string, int n, Object targetObj) {
        if ((n & 2) != 0) {
            string = null;
        }
    ...
    public final void BaseCoreGenericHandler(@NotNull LiteBansModule_83 ch2, @NotNull CommandSenderWrapper sender) {
        KickOtherHandler gx_02;
        List list = ch2.BaseCoreGenericHandler(sender.BaseCoreGenericHandler(), sender.LiteBansModule_31(), BanHandler.LiteBansModule_241, "__ALL__", true, 0);
        GeoIPLookupService_3 gu2 = this.c();
        ObjectUtilities.LiteBansModule_31(gu2, "");
    ...
    public final boolean BaseCoreGenericHandler(@Nullable SilentHandler dZ2) {
        ...
        if ((dZ3 != null ? dZ3.ServerSyncService() : null) == BanHandler.LiteBansModule_241) {
            Object targetObj = dZ2.DatabaseMonitorService();
            if (LiteBansModule_346.BaseCoreGenericHandler((String)targetObj) && this.plugin.AsyncBackgroundTask_22() == 1) {
                GeoIPLookupService_3 gu2 = this.c();
                ObjectUtilities.LiteBansModule_31(gu2, "");
                targetObj = (KickOtherHandler)gu2;
                String string = dZ2.DatabaseMonitorService();
                ObjectUtilities.BaseCoreGenericHandler((Object)string);
                n = ((KickOtherHandler)targetObj).BaseCoreGenericHandler(string);
                Collection collection = (Collection)((KickOtherHandler)targetObj).LiteBansModule_31().get(n);
                if (collection == null) {
                    return false;
                }
                Collection collection2 = collection;
                Map map = ((KickOtherHandler)targetObj).LiteBansModule_31();
                Integer n2 = n;
    ...
    public final void BaseCoreGenericHandler(@NotNull CommandSenderWrapper sender, @Nullable String string) {
        ...
        if (ec_02 instanceof BungeecordHandler_2 && this.m().LiteBansModule_195().LiteBansModule_13()) {
    ...
    public final void BaseCoreGenericHandler(@NotNull LiteBansModule_83 ch2, @NotNull CommandSenderWrapper sender, @NotNull SilentHandler dZ2, int n, @NotNull String string) {
        if (!this.m().LiteBansModule_195().B()) {
            return;
        }
        Object targetObj = sender;
        CharSequence charSequence = "litebans + " + string;
        if (targetObj.e((String)charSequence)) {
            CharSequence charSequence2;
            switch (LiteBansModule_251.BaseCoreGenericHandler[dZ2.ServerSyncService().ordinal()]) {
                case 1: {
                    Object contextObj = MessageKey.bS;
                    break;
                }
                case 2: {
                    if (dZ2.HoverTextFormatter()) {
                        contextObj = MessageKey.dK;
                        break;
                    }
                    contextObj = MessageKey.e;
                    break;
                }
                default: {
                    Object contextObj = targetObj = MessageKey.Y;
                }
            }
            if ((charSequence2 = GeoIPLookupService.BaseCoreGenericHandler(ch2, dZ2, n, 0, 4, null)) == null) {
                charSequence2 = charSequence = (CharSequence)targetObj;
            }
            if (dZ2.ServerSyncService() == BanHandler.c) {
                charSequence = GeoIPLookupService.BaseCoreGenericHandler(charSequence, (CharSequence)"duration", (Object)this.m().LiteBansModule_195().ar());
            }
    ...
    public final String BaseCoreGenericHandler(@Nullable String string, @Nullable String string2) {
        ...
        if (this.m().LiteBansModule_195().SetHandler() && string2 != null && (sender = this.plugin(string2)) != null) {
            return sender.g();
        }
        return string;
    }
    ...
    private static final KotlinUnitHandler BaseCoreGenericHandler(SilentHandler dZ2, CommandSenderWrapper sender, BroadcastService o2, LiteBansModule_83 ch2) {
    ...
    private static final void BaseCoreGenericHandler(BroadcastService o2, String string, int n, String string2) {
        try {
            ...
            block23: {
                ...
                if (!o2.BaseCoreGenericHandler.LiteBansModule_403()) {
                    targetObj = sender;
                    string3 = "litebans.exempt.dupeip_join";
                    flag = false;
                    contextObj = targetObj;
                    if (!contextObj.e(string3)) {
                        targetObj = (AsyncBackgroundTask_22)o2.BaseCoreGenericHandler.BaseCoreGenericHandler(AsyncBackgroundTask_22.class);
                        string3 = sender.LiteBansModule_31();
                        if (string3 != null) {
                            ((AsyncBackgroundTask_22)targetObj).BaseCoreGenericHandler(string2, sender.BaseCoreGenericHandler(), string3);
                        }
                    }
                }
                targetObj = sender;
                ...
                if (targetObj.e(string3)) {
                    ...
                    try {
                        ...
                        try {
                            Object resultObj = (LiteBansModule_83)contextObj;
                        ...
                        if (((DatabaseMonitorService)targetObj).LiteBansModule_31(sQLException)) break block23;
                        throw sQLException;
                    }
                }
            }
            ...
            if (targetObj.e(string3)) {
                targetObj = o2.BaseCoreGenericHandler.LiteBansModule_241();
                if (((DatabaseService)targetObj).LiteBansModule_31() != null) {
    ...
    private static final void g() {
        LiteBansModule_241 = new String[]{"", "", "", "", "", "Local messages are disabled, discarding message: \"", "console", "litebans.notify", "litebans + ", "litebans + ", "litebans + ", " + ", "Unbanned player: ", "pgsql", "postgresql", "B'0'", "B'1'", " ILIKE ", "0", "1", "=", "sqlite", "name,uuid,ip,datetime(date) CommandExitException date", " COLLATE NOCASE ", "name,uuid,ip,UNIX_TIMESTAMP(date) CommandExitException date", " ", "*", " ", "UTC", "[Console]", "CONSOLE", "", StringDecryptor.BaseCoreGenericHandler("\u11cb\u11f2\u11e4\u11ec\u11d7\u11e2\u11f5\u11ea\u11f4", 0x78781187), "org.sqlite", "org.sqlite", "", "", "__ALL__", "", "", "litebans + ", "duration", "litebans.exempt.dupeip_join", "litebans.notify.warned.offline", "Notified %AsyncBackgroundTask_21 of %AsyncBackgroundTask_5 %", "warning", "warnings", "litebans.admin"};
    }
}
}
