...
public final class LiteBansModule_120 {
    public static final LiteBansModule_183 c = new LiteBansModule_183(null);
    private final int AsyncBackgroundTask_5;
    private final int LiteBansModule_31;
    private final int BaseCoreGenericHandler;

    public LiteBansModule_120(int n, int n2, int n3) {
