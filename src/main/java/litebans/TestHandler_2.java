...
extends MessageHandler {
    ...
    public final void BaseCoreGenericHandler(@NotNull Object targetObj, @NotNull String string, @NotNull CommandSenderWrapper sender, boolean flag) {
        ...
        UUID uUID = sender.AsyncBackgroundTask_5();
                String string2 = ((ConfigService)((MessageHandler)contextObj).LiteBansModule_241().BaseCoreGenericHandler(ConfigService.class)).BaseCoreGenericHandler(sender, targetObj);
                PunishmentTableService p2 = (PunishmentTableService)((MessageHandler)resultObj).LiteBansModule_241().BaseCoreGenericHandler(PunishmentTableService.class);
        String string3 = sender.LiteBansModule_241();
        if (string3 == null) {
            MessageHandler messageHandler = this;
            flag3 = false;
            string3 = ((DatabaseMonitorService)messageHandler.LiteBansModule_241().BaseCoreGenericHandler(DatabaseMonitorService.class)).ServerSyncService();
        }
        contextObj = p2.BaseCoreGenericHandler(uUID, string2, string3);
        resultObj = this;
        n = 0;
        resultObj = (ConfigService)((MessageHandler)resultObj).LiteBansModule_241().BaseCoreGenericHandler(ConfigService.class);
        n = 100;
        flag3 = false;
        ...
        if (flag || ((CharSequence)string).length() == 0 || string.charAt(0) != '/') {
            ...
            block11: {
                object6 = new char[]{' '};
                resultObj = (String)StringUtilities.BaseCoreGenericHandler((CharSequence)string, object6, false, 0, 6, null).get(0);
                tempObj = this;
                flag2 = false;
                object6 = ((ConfigService)((MessageHandler)tempObj).LiteBansModule_241().BaseCoreGenericHandler(ConfigService.class)).LiteBansModule_195();
                tempObj = null;
                Object object7 = string;
                tempObj = ((String)object7).toLowerCase(Locale.ROOT);
                if (LiteBansModule_243.BaseCoreGenericHandler((CharSequence)tempObj)) {
                    tempObj = LiteBansModule_243.LiteBansModule_31((CharSequence)tempObj);
                }
                if (StringUtilities.c((CharSequence)resultObj, ':', false, 2, null) && object6.InitHandler()) {
    ...
    public final void BaseCoreGenericHandler(@NotNull Object targetObj, @NotNull CommandSenderWrapper sender, @Nullable String string, @Nullable SilentHandler dZ2) {
        KickBannedHandler.BaseCoreGenericHandler(this.LiteBansModule_241().i(), targetObj, null, null, false, null, 30, null);
        if (dZ2 != null) {
                        contextObj = (PunishmentTableService)((MessageHandler)contextObj).LiteBansModule_241().BaseCoreGenericHandler(PunishmentTableService.class);
            flag = false;
    ...
    private static final void BaseCoreGenericHandler() {
        LiteBansModule_195 = new String[]{"test", "[+] Mute for ", " is ", "^/[^ ]+:", "/"};
    }
}
