...
implements Runnable {
    ...
    private HistoryCleanupTask(HikariPool dr2) {
        ...
        this.plugin = LiteBansModule_150.BaseCoreGenericHandler(LiteBansModule_150.LiteBansModule_31(), -HikariPool.e(this.LiteBansModule_31));
    }
    ...
    public void run() {
        try {
            ...
            this.LiteBansModule_31.LiteBansModule_195 = this.LiteBansModule_31.AsyncBackgroundTask_22.LiteBansModule_241();
            HikariPool.LiteBansModule_195(this.LiteBansModule_31).BaseCoreGenericHandler(this.LiteBansModule_31.AsyncBackgroundTask_22.g());
            ...
            if (LiteBansModule_150.BaseCoreGenericHandler(l5, 128L) < LiteBansModule_150.BaseCoreGenericHandler(this.plugin, HikariPool.e(this.LiteBansModule_31))) {
                HikariPool.LiteBansModule_31(this.LiteBansModule_31).c("%AsyncBackgroundTask_21 - Retrograde clock change detected (housekeeper delta=%AsyncBackgroundTask_21), soft-evicting connections from ", new Object[]{this.LiteBansModule_31.e, LiteBansModule_150.e(this.plugin, l5)});
                this.plugin = l5;
            ...
            this.plugin = l5;
            String string = "Pool ";
            if (l3 > 0L && this.LiteBansModule_31.AsyncBackgroundTask_22.i() < this.LiteBansModule_31.AsyncBackgroundTask_22.LiteBansModule_195()) {
                ...
                for (InUseHandler kJ2 : list) {
                    if (n <= 0 || LiteBansModule_150.g(kJ2.e, l5) <= l3 || !HikariPool.BaseCoreGenericHandler(this.LiteBansModule_31).BaseCoreGenericHandler(kJ2)) continue;
    ...
    /* synthetic */ HistoryCleanupTask(HikariPool dr2, LiteBansModule_333 j92) {
        this(dr2);
    }
}
