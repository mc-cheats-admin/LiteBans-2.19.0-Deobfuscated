...
public final class LiteBansModule_418
...
PreparedStatement {
    ...
    public void setObject(int n, Object targetObj, int n2) {
        try {
            ((PreparedStatement)this.plugin).setObject(n, targetObj, n2);
        }
        catch (SQLException sQLException) {
            throw this.plugin(sQLException);
        }
    ...
    public void setObject(int n, Object targetObj) {
        try {
            ((PreparedStatement)this.plugin).setObject(n, targetObj);
        }
        catch (SQLException sQLException) {
            throw this.plugin(sQLException);
        }
    ...
    public void setObject(int n, Object targetObj, int n2, int n3) {
        try {
            ((PreparedStatement)this.plugin).setObject(n, targetObj, n2, n3);
        }
        catch (SQLException sQLException) {
            throw this.plugin(sQLException);
        }
    ...
    public void setObject(int n, Object targetObj, SQLType sQLType, int n2) {
        try {
            ((PreparedStatement)this.plugin).setObject(n, targetObj, sQLType, n2);
        }
        catch (SQLException sQLException) {
            throw this.plugin(sQLException);
        }
    ...
    public void setObject(int n, Object targetObj, SQLType sQLType) {
        try {
            ((PreparedStatement)this.plugin).setObject(n, targetObj, sQLType);
        }
        catch (SQLException sQLException) {
            throw this.plugin(sQLException);
        }
    ...
    LiteBansModule_418(LiteBansModule_66 c22, PreparedStatement preparedStatement) {
