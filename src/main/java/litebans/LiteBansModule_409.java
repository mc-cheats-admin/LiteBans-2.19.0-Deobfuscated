...
implements LiteBansModule_51 {
    ...
    private final LiteBansModule_99 BaseCoreGenericHandler;
        public LiteBansModule_409(@NotNull PlatformPlugin plugin, @NotNull LiteBansModule_99 cr_02) {
        this.c = plugin;
        this.plugin = cr_02;
    }
    ...
    public LiteBansModule_409 c() {
        LiteBansModule_409 ld2;
        LiteBansModule_409 ld3 = ld2 = this;
    ...
    public final void BaseCoreGenericHandler(@NotNull ServerLoginPacketListenerImpl serverLoginPacketListenerImpl, @NotNull MinecraftServer minecraftServer, @NotNull PacketSender packetSender, @NotNull ServerLoginNetworking.LoginSynchronizer loginSynchronizer) {
        ...
        h82.BaseCoreGenericHandler(serverLoginPacketListenerImpl, loginSynchronizer, new LiteBansModule_96(gameProfile.name(), gameProfile.SQLiteDriverHandler_4().toString(), this.plugin.BaseCoreGenericHandler(connection)), connection);
    }
    ...
    static {
        LiteBansModule_409.BaseCoreGenericHandler();
    }
}
