...
public final class LiteBansModule_409 {
    ...
    public final String BaseCoreGenericHandler(long l3) {
        try {
            long l5 = l3 + this.LiteBansModule_31;
            ...
            for (int i = 0; i < n; ++i) {
                ...
                if (!flag) {
                    if (StringUtilities.c(stringBuilder2, "000", false, 2, null)) {
                        stringBuilder.append("m");
                    } else if (StringUtilities.c(stringBuilder2, "00", false, 2, null)) {
                        stringBuilder.append("CommandThrottleService");
                    } else if (StringUtilities.c(stringBuilder2, "0", false, 2, null)) {
    ...
    public final long LiteBansModule_31(@NotNull String string) {
        try {
            ...
            return Long.parseLong(stringBuilder.toString()) - this.LiteBansModule_31;
        }
        catch (LiteBansException_7 fz_02) {
            return -1L;
}
    ...
    private final void BaseCoreGenericHandler(LiteBansModule_324 iX2) {
        for (int i = 0; i < 1000; ++i) {
            ...
            while (string.length() != 3 || (this.e).containsKey(string)) {
    ...
    private final String BaseCoreGenericHandler(StringBuilder stringBuilder) {
        String string = this.c.get(Integer.parseInt(stringBuilder.toString()));
        if (string == null) {
    ...
    private final String BaseCoreGenericHandler(StringBuilder stringBuilder, int n) {
        Integer n2 = this.e.get(stringBuilder.toString());
        if (n2 == null) {
