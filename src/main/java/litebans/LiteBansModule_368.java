...
implements Cloneable {
    ...
    public boolean equals(Object targetObj) {
        ...
        if (!(targetObj instanceof LiteBansModule_368)) {
            return false;
        }
        LiteBansModule_368 ka_02 = (LiteBansModule_368)targetObj;
    ...
    public int hashCode() {
        ...
        int n2 = 1;
        Boolean flag = this.plugin;
        n2 = n2 * 59 + (flag == null ? 43 : (flag).hashCode());
        Boolean flag2 = this.e;
        n2 = n2 * 59 + (flag2 == null ? 43 : (flag2).hashCode());
        Boolean flag3 = this.LiteBansModule_240;
        n2 = n2 * 59 + (flag3 == null ? 43 : (flag3).hashCode());
        Boolean flag4 = this.LiteBansModule_31;
        n2 = n2 * 59 + (flag4 == null ? 43 : (flag4).hashCode());
        Boolean flag5 = this.c;
        n2 = n2 * 59 + (flag5 == null ? 43 : (flag5).hashCode());
        LiteBansType gq2 = this.AsyncBackgroundTask_5();
        n2 = n2 * 59 + (gq2 == null ? 43 : (gq2).hashCode());
        Color color = this.c();
        n2 = n2 * 59 + (color == null ? 43 : (color).hashCode());
        String string = this.g();
