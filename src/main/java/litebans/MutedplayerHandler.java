...
extends MessageHandler {
    ...
    private static final KotlinUnitHandler BaseCoreGenericHandler(MutedplayerHandler gP2, LiteBansModule_82 ch2) {
        ...
        CommandArgumentUtils.BaseCoreGenericHandler((MessageHandler)gP2, GeoIPLookupService.BaseCoreGenericHandler(ch2, gP2.LiteBansModule_194, gP2.AsyncBackgroundTask_5(), charSequence2, 0L, 8, null));
        if (!v2.BaseCoreGenericHandler((byte)1, gP2.AsyncBackgroundTask_5().BaseCoreGenericHandler())) {
            Object targetObj = gP2;
            if (((ConfigService)targetObj.LiteBansModule_240().BaseCoreGenericHandler(ConfigService.class)).LiteBansModule_194().c()) {
                MessageHandler messageHandler = gP2;
                MessageHandler fg_03 = messageHandler;
                targetObj = GeoIPLookupService.BaseCoreGenericHandler(ch2, gP2.LiteBansModule_194, gP2.AsyncBackgroundTask_5(), GeoIPLookupService.BaseCoreGenericHandler(MessageKey.LiteBansModule_56.BaseCoreGenericHandler("mutedPlayer", (Object)(((ConfigService)fg_03.LiteBansModule_240().BaseCoreGenericHandler(ConfigService.class)).LiteBansModule_194().SetHandler() ? gP2.AsyncBackgroundTask_5().g() : gP2.AsyncBackgroundTask_5().i())), (CharSequence)"message", gP2.AsyncBackgroundTask_5), 0L, 8, null);
                ...
                flag2 = false;
                BroadcastService.BaseCoreGenericHandler(o2, ch2, targetObj, "mute", BanHandler.GnuSparseMapHandler, gP2.LiteBansModule_194.GnuSparseMapHandler(), false, false, null, 112, null);
                CommandArgumentUtils.BaseCoreGenericHandler(ch2, BroadcastHandler.q, targetObj, null, null, 12, null);
}
