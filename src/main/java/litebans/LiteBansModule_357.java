...
public class LiteBansModule_357 {
    private static final int LiteBansModule_31 = 255;
    static final LiteBansModule_120 c = Utf8Handler.LiteBansModule_31(null);
    static final LiteBansModule_120 BaseCoreGenericHandler = new LiteBansModule_119();
    ...
    public static final long c(byte[] byArray, int n, int n2) {
        ...
        while (n3 < n4) {
            byte by3 = byArray[n3];
            if (by3 < 48 || by3 > 55) {
                throw new IllegalArgumentException(LiteBansModule_357.BaseCoreGenericHandler(byArray, n, n2, n3, by3));
            }
            l3 = (l3 << 3) + (long)(by3 - 48);
            ++n3;
        }
    ...
    public static final long BaseCoreGenericHandler(byte[] byArray, int n, int n2) {
        boolean flag;
        if ((byArray[n] & 0x80) == 0) {
            return LiteBansModule_357.c(byArray, n, n2);
        }
        boolean flag2 = flag = byArray[n] == -1;
        if (n2 < 9) {
            return LiteBansModule_357.LiteBansModule_31(byArray, n, n2, flag);
        }
        return LiteBansModule_357.BaseCoreGenericHandler(byArray, n, n2, flag);
    }
    ...
    public static final String LiteBansModule_31(byte[] byArray, int n, int n2) {
        try {
            return LiteBansModule_357.BaseCoreGenericHandler(byArray, n, n2, c);
        }
        catch (IOException iOException) {
            try {
                return LiteBansModule_357.BaseCoreGenericHandler(byArray, n, n2, BaseCoreGenericHandler);
            }
    ...
    public static final String BaseCoreGenericHandler(byte[] byArray, int n, int n2, LiteBansModule_120 dd_02) {
        int n4 = n;
    ...
    public static final LiteBansModule_293 LiteBansModule_31(byte[] byArray, int n) {
        long l3 = LiteBansModule_357.BaseCoreGenericHandler(byArray, n, 12);
        long l5 = LiteBansModule_357.BaseCoreGenericHandler(byArray, n + 12, 12);
        return new LiteBansModule_293(l3, l5);
    }

    public static final boolean BaseCoreGenericHandler(byte[] byArray) {
        long l3 = LiteBansModule_357.c(byArray, 148, 8);
        long l5 = 0L;
        long l7 = 0L;
