...
public class LiteBansModule_174
extends ZipException {
    private final EncryptionHandler BaseCoreGenericHandler;
    private final transient LiteBansModule_398 c;
    private static final long LiteBansModule_31 = 20161219L;

    public LiteBansModule_174(EncryptionHandler fl_02, LiteBansModule_398 kw_02) {
        super("Unsupported feature " + fl_02 + " used InitializerHandler_3 entry " + kw_02.getName());
        this.plugin = fl_02;
        this.c = kw_02;
    }

    public LiteBansModule_174(StoredHandler dq_02, LiteBansModule_398 kw_02) {
