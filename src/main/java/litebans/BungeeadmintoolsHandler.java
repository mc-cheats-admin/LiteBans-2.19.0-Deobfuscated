...
extends BansHandler {
                    ...
                    try {
                        ...
                        if (string3 != null) {
                            ...
                            try {
                                ...
                                object10 = this;
                                ((DatabaseMonitorService)((MessageHandler)object10).LiteBansModule_241().BaseCoreGenericHandler(DatabaseMonitorService.class)).BaseCoreGenericHandler(exception);
                            }
                        }
                        if (string4 == null && resultObj != null) {
                            string4 = this.plugin(UUID.fromString((String)resultObj));
                        }
                        ...
                        if (object11 != null) {
                            try {
                                ...
                                object8 = this;
                                ((DatabaseMonitorService)((MessageHandler)object8).LiteBansModule_241().BaseCoreGenericHandler(DatabaseMonitorService.class)).BaseCoreGenericHandler(exception);
                            }
                        }
                        ...
                        messageHandler = this;
                        bl12 = false;
                        object8 = o2.BaseCoreGenericHandler(resultSet, "ban_begin", false, ((ConfigService)messageHandler.LiteBansModule_241().BaseCoreGenericHandler(ConfigService.class)).LiteBansModule_195().ElementsHandler());
                        long l3 = ((Date)object8).getTime();
                        object6 = this;
                        BroadcastService o3 = (BroadcastService)((MessageHandler)object6).LiteBansModule_241().BaseCoreGenericHandler(BroadcastService.class);
                        object6 = this;
                        bl13 = false;
                        object7 = o3.BaseCoreGenericHandler(resultSet, "ban_end", false, ((ConfigService)((MessageHandler)object6).LiteBansModule_241().BaseCoreGenericHandler(ConfigService.class)).LiteBansModule_195().ElementsHandler());
                        ...
                        if (flag4 || AllHandler_3.BaseCoreGenericHandler(ch2, (String)resultObj, null, null, false, false, 30, null) == null) {
                            ...
                            SilentHandler dZ2 = new SilentHandler(BanHandler.LiteBansModule_241, (String)resultObj, string5, charSequence, (String)object14, (String)object11, LiteBansModule_182.LiteBansModule_195.LiteBansModule_31(), null, l3, l5, 0, false, flag4, false, 0L, 27648, null);
                            ch2.c(dZ2);
                            helperObj = flag4 ? this.LiteBansModule_195().incrementAndGet() : this.g().incrementAndGet();
                        } else {
                        ...
                        new LiteBansModule_222(this.LiteBansModule_241(), string4, (String)resultObj, "#").run();
                    }
                    catch (Exception exception) {
                        resultObj = this;
                        ((DatabaseMonitorService)((MessageHandler)resultObj).LiteBansModule_241().BaseCoreGenericHandler(DatabaseMonitorService.class)).BaseCoreGenericHandler(exception);
                    }
                }
    ...
    static {
        BungeeadmintoolsHandler.BaseCoreGenericHandler();
    }
}
