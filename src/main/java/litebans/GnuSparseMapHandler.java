...
extends LiteBansModule_154 {
    ...
    private final int LiteBansModule_403;
    private final int r;
    private boolean n;
    private long g;
    private long e;
    ...
    private final LiteBansModule_120 AsyncBackgroundTask_21;
    final String LiteBansModule_241;
    ...
    public long skip(long l3) {
        ...
        long l7 = !this.AsyncBackgroundTask_5.LiteBansModule_403() ? LiteBansModule_342.BaseCoreGenericHandler(this.i, Math.min(l3, l5)) : this.plugin(Math.min(l3, l5));
    ...
    public UserNameHandler AsyncBackgroundTask_5() {
        ...
        if (this.AsyncBackgroundTask_5 != null) {
            LiteBansModule_342.BaseCoreGenericHandler((InputStream)this, Long.MAX_VALUE);
            this.LiteBansModule_195();
        }
        if ((byArray2 = this.LiteBansModule_241()) == null) {
            this.AsyncBackgroundTask_5 = null;
            return null;
        }
        try {
            this.AsyncBackgroundTask_5 = new UserNameHandler(byArray2, this.AsyncBackgroundTask_21, this.LiteBansModule_195);
        }
    ...
    private final void LiteBansModule_195() {
        if (!this.GnuSparseMapHandler() && this.g > 0L && this.g % (long)this.LiteBansModule_403 != 0L) {
            long l3 = this.g / (long)this.LiteBansModule_403 + 1L;
            long l5 = l3 * (long)this.LiteBansModule_403 - this.g;
            long l7 = LiteBansModule_342.BaseCoreGenericHandler(this.i, l5);
            this.LiteBansModule_31(l7);
        }
    }
    ...
    private final byte[] LiteBansModule_241() {
        byte[] byArray = this.LiteBansModule_403();
    ...
    protected boolean BaseCoreGenericHandler(byte[] byArray) {
        return byArray == null || LiteBansModule_77.BaseCoreGenericHandler(byArray, this.LiteBansModule_403);
    }

    protected byte[] LiteBansModule_403() {
        byte[] byArray = new byte[this.LiteBansModule_403];
        int n = LiteBansModule_342.BaseCoreGenericHandler(this.i, byArray);
        this.plugin(n);
        if (n != this.LiteBansModule_403) {
            return null;
        }
        return byArray;
    }
    ...
    private final List BaseCoreGenericHandler(String string) {
        ArrayList<LiteBansModule_293> arrayList = new ArrayList<LiteBansModule_293>();
        String[] args = string.split(",");
        for (int i = 0; i < args.length; i += 2) {
            long l3 = Long.parseLong(args[i]);
            long l5 = Long.parseLong(args[i + 1]);
            arrayList.add(new LiteBansModule_293(l3, l5));
        }
        return arrayList;
    }
    ...
    private final List m() {
        ...
        while (l7-- > 0L) {
            ...
            long l8 = lArray[0];
            l5 += lArray[1];
            arrayList.add(new LiteBansModule_293(l3, l8));
        }
        l3 = (long)this.LiteBansModule_403 - l5 % (long)this.LiteBansModule_403;
        LiteBansModule_342.BaseCoreGenericHandler(this.i, l3);
        return arrayList;
    }
                ...
                if (n == 32) {
                    ...
                    while ((n = inputStream.read()) != -1) {
                        ...
                        if (n == 61) {
                            ...
                            int n5 = LiteBansModule_342.BaseCoreGenericHandler(inputStream, byArray);
                            if (n5 != n4) {
                            ...
                            if (string.equals("GNU.sparse.offset")) {
                                if (l3 != null) {
                                    list.add(new LiteBansModule_293(l3, 0L));
                                }
                            ...
                            list.add(new LiteBansModule_293(l3, Long.parseLong(string2)));
                            l3 = null;
                            continue block0;
                        }
    ...
    private final void n() {
        if (this.AsyncBackgroundTask_5.LiteBansModule_31()) {
            LiteBansModule_137 dT2;
            do {
                byte[] byArray;
                if ((byArray = this.LiteBansModule_241()) == null) {
                    this.AsyncBackgroundTask_5 = null;
                    break;
                }
                dT2 = new LiteBansModule_137(byArray);
                this.AsyncBackgroundTask_5.LiteBansModule_195().addAll(dT2.BaseCoreGenericHandler());
    ...
    @Override
    public LiteBansModule_236 BaseCoreGenericHandler() {
        return this.AsyncBackgroundTask_5();
    }
    ...
    private final void BaseCoreGenericHandler() {
        ...
        if (flag2) {
            this.i.mark(this.LiteBansModule_403);
        }
        try {
            flag = !this.plugin(this.LiteBansModule_403());
        }
        finally {
            if (flag && flag2) {
                this.plugin((long)this.LiteBansModule_403);
                this.i.reset();
            }
        }
    }
    ...
    public int read(byte[] byArray, int n, int n2) {
        ...
        if (!this.AsyncBackgroundTask_5.LiteBansModule_403() ? this.e >= this.g : this.e >= this.AsyncBackgroundTask_5.g()) {
            return -1;
        }
        n2 = Math.min(n2, this.available());
        n3 = this.AsyncBackgroundTask_5.LiteBansModule_403() ? this.plugin(byArray, n, n2) : this.i.read(byArray, n, n2);
        if (n3 == -1) {
            if (n2 > 0) {
    ...
    private final void g() {
        ...
        if (l3 > 0L) {
            long l5 = LiteBansModule_342.BaseCoreGenericHandler(this.i, (long)this.r - l3);
    ...
    private final void i() {
        ...
        List list = this.AsyncBackgroundTask_5.LiteBansModule_195();
        if (list != null && list.size() > 1) {
            targetObj = new LiteBansModule_52(this);
            Collections.sort(list, targetObj);
        }
        if (list != null) {
            LiteBansModule_293 i72;
            targetObj = new LiteBansModule_130(null);
            long l3 = 0L;
            Iterator iterator = list.iterator();
            while (iterator.hasNext() && ((i72 = (LiteBansModule_293)iterator.next()).BaseCoreGenericHandler() != 0L || i72.LiteBansModule_31() != 0L)) {
                if (i72.BaseCoreGenericHandler() - l3 < 0L) {
                    throw new IOException("Corrupted struct sparse detected");
                }
                if (i72.BaseCoreGenericHandler() - l3 > 0L) {
                    this.PunishmentTableService.add(new LiteBansModule_280((InputStream)targetObj, i72.BaseCoreGenericHandler() - l3));
                }
                if (i72.LiteBansModule_31() > 0L) {
                    this.PunishmentTableService.add(new LiteBansModule_280(this.i, i72.LiteBansModule_31()));
                }
