...
extends Enum {
    ...
    public static final WhiteoutHandler LiteBansModule_195 = new WhiteoutHandler("BLKDEV", 4, 6);
    ...
    public static final WhiteoutHandler BaseCoreGenericHandler(int n) {
        ...
        for (WhiteoutHandler lh_03 : WhiteoutHandler.values()) {
            if (n != lh_03.LiteBansModule_241) continue;
            lh_02 = lh_03;
        }
        return lh_02;
    }
    ...
    static {
        i = new WhiteoutHandler[]{g, GnuSparseMapHandler, BaseCoreGenericHandler, AsyncBackgroundTask_5, LiteBansModule_195, LiteBansModule_31, Utf8Handler_2, c, e};
    }
}
