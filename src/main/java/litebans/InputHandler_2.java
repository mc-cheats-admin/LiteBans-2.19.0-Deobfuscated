...
implements LiteBansModule_296 {
    ...
    private final LiteBansModule_97 LiteBansModule_31;
        public InputHandler_2(@NotNull CharSequence charSequence, int n, int n2, @NotNull LiteBansModule_97 cQ2) {
    ...
    public Iterator BaseCoreGenericHandler() {
        return new LiteBansModule_334(this);
    }
    ...
    public static final /* synthetic */ LiteBansModule_97 LiteBansModule_31(InputHandler_2 ee_02) {
    ...
    static {
        InputHandler_2.BaseCoreGenericHandler();
    }
}
