...
extends BansHandler {
    ...
    private final DateFormat m = new SimpleDateFormat("yyyy-MM-LiteBansModule_119 HH:mm:ss NullHandler_8");
    ...
    public void BaseCoreGenericHandler(@NotNull String string, @NotNull Connection connection, @NotNull LiteBansModule_83 ch2, boolean flag) {
        ...
        Object contextObj = LiteBansModule_345.LiteBansModule_31;
        int n = 8192;
        Object resultObj = targetObj;
        BufferedReader bufferedReader = (resultObj = (Reader)new InputStreamReader((InputStream)new FileInputStream((File)resultObj), (Charset)contextObj)) instanceof BufferedReader ? (BufferedReader)resultObj : new BufferedReader((Reader)resultObj, n);
    ...
    private final void BaseCoreGenericHandler(NullHandler_7 ks_02, LiteBansModule_83 ch2) {
        ...
        for (Object e : ks_02) {
            try {
                ...
                SilentHandler dZ2 = new SilentHandler(BanHandler.LiteBansModule_241, string4, null, string7, this.LiteBansModule_31(string), string, "*", null, l3, l5, 0, false, false, false, 0L, 31744, null);
                ...
                new LiteBansModule_222(this.LiteBansModule_241(), string3, string4, null).run();
            }
    ...
    private final void BaseCoreGenericHandler(String string, String string2, NullHandler_3 gr_02, Exception exception) {
        this.LiteBansModule_241().getLogger().warning("Failed to import ban for " + string + " (created LiteBansModule_61 " + string2 + "). JSON data:");
        NullHandler_3 gr_03 = gr_02;
        this.LiteBansModule_241().getLogger().warning(gr_03 != null ? gr_03.BaseCoreGenericHandler() : null);
    ...
    private static final void BaseCoreGenericHandler() {
        BroadcastService = new String[]{"vanilla", "banned-players.json", "yyyy-MM-LiteBansModule_119 HH:mm:ss NullHandler_8", "banned-players", "essentials", "", "", "", "name", "uuid", "created", "source", "expires", "forever", "reason", "", "*", "Ignoring duplicate ban for ", "Failed to import ban for ", " (created LiteBansModule_61 ", "). JSON data:"};
    }

    static {
        VanillaHandler.BaseCoreGenericHandler();
    }
}
