...
public class InsertionHandler {
    ...
    protected void BaseCoreGenericHandler(JsonObject jsonObject, LiteBansModule_432 v_02, JsonDeserializationContext jsonDeserializationContext) {
        ...
        if (jsonObject2 != null) {
            ...
            if (flag) {
                switch (LiteBansModule_165.BaseCoreGenericHandler[((Enum)contextObj).ordinal()]) {
                    case 1: {
                        v_02.BaseCoreGenericHandler(new LiteBansModule_377((OpenUrlHandler)(contextObj), jsonObject2.get("url").getAsString()));
                        break;
                    }
                    case 2:
                    case 3: {
                        v_02.BaseCoreGenericHandler(new LiteBansModule_377((OpenUrlHandler)(contextObj), jsonObject2.get("command").getAsString()));
                        break;
                    }
                    case 4: {
                        n = jsonObject2.get("page").getAsInt();
                        Preconditions.checkArgument((n >= 0 ? 1 : 0) != 0, (Object)"Page number has to be positive");
                        v_02.BaseCoreGenericHandler(new LiteBansModule_377((OpenUrlHandler)(contextObj), Integer.toString(n)));
                        break;
                    }
                    default: {
                        v_02.BaseCoreGenericHandler(new LiteBansModule_377((OpenUrlHandler)(contextObj), jsonObject2.has("value") ? jsonObject2.get("value").getAsString() : ""));
                        break;
} else {
                v_02.BaseCoreGenericHandler(new LiteBansModule_377((OpenUrlHandler)(contextObj), jsonObject2.has("value") ? jsonObject2.get("value").getAsString() : ""));
}
        ...
        if (contextObj != null) {
            ...
            if (n != 0 || contextObj.has("contents")) {
                ...
                if (jsonElement2 != null) {
                    ...
                    targetObj = new ActionHandler(eA2, new ArrayList<LiteBansModule_160>(Arrays.asList(ed_0Array)));
} else {
            ...
            if (targetObj != null) {
                v_02.BaseCoreGenericHandlertargetObj;
}
        if ((targetObj = jsonObject.get("extra")) != null) {
            v_02.BaseCoreGenericHandler(Arrays.asList((LiteBansModule_432[])jsonDeserializationContext.deserialize(targetObj, LiteBansModule_432[].class)));
}
        ...
        try {
            ...
            if (v_02.LiteBansModule_194() != null) {
                ...
                switch (this.plugin.LiteBansModule_31()) {
                    ...
                    default: {
                        throw new IllegalArgumentException("Unknown version " + (Object)(this.plugin.LiteBansModule_31()));
}
            ...
            if (v_02.CommandThrottleService() != null) {
                jsonObject.add("extra", jsonSerializationContext.serialize(v_02.CommandThrottleService()));
}
        finally {
