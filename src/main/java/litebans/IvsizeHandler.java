...
extends LiteBansModule_24 {
    ...
    private long LiteBansModule_195;
    private NoneHandler LiteBansModule_241;
    ...
    public IvsizeHandler() {
        super(new LiteBansModule_289(23));
    }

    public void c(byte[] byArray, int n, int n2) {
        this.plugin(12, n2);
        this.Utf8Handler_2 = LiteBansModule_289.BaseCoreGenericHandler(byArray, n);
        this.g = DesHandler.BaseCoreGenericHandler(LiteBansModule_289.BaseCoreGenericHandler(byArray, n + 2));
        this.BroadcastService = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + 4);
        this.LiteBansModule_403 = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + 6);
        this.LiteBansModule_195 = LiteBansModule_85.BaseCoreGenericHandler(byArray, n + 8);
        if (this.LiteBansModule_195 > 0L) {
            this.plugin(16, n2);
            this.LiteBansModule_241 = NoneHandler.BaseCoreGenericHandler(LiteBansModule_289.BaseCoreGenericHandler(byArray, n + 12));
            this.PunishmentTableService = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + 14);
            for (long i = 0L; i < this.LiteBansModule_195; ++i) {
    ...
    public void AsyncBackgroundTask_5(byte[] byArray, int n, int n2) {
        ...
        this.Utf8Handler_2 = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + n3 + 6);
        this.g = DesHandler.BaseCoreGenericHandler(LiteBansModule_289.BaseCoreGenericHandler(byArray, n + n3 + 8));
        this.BroadcastService = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + n3 + 10);
        this.LiteBansModule_403 = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + n3 + 12);
        int n4 = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + n3 + 14);
        this.plugin("erdSize", n4, n3 + 16, n2);
        this.m = Arrays.copyOfRange(byArray, n + n3 + 16, n4);
        this.plugin(20 + n3 + n4, n2);
        this.LiteBansModule_195 = LiteBansModule_85.BaseCoreGenericHandler(byArray, n + n3 + 16 + n4);
        if (this.LiteBansModule_195 == 0L) {
            this.plugin(n3 + 20 + n4 + 2, n2);
            int n5 = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + n3 + 20 + n4);
            ...
            this.LiteBansModule_241 = NoneHandler.BaseCoreGenericHandler(LiteBansModule_289.BaseCoreGenericHandler(byArray, n + n3 + 20 + n4));
            this.PunishmentTableService = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + n3 + 22 + n4);
            int n6 = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + n3 + 24 + n4);
            ...
            int n7 = LiteBansModule_289.BaseCoreGenericHandler(byArray, n + n3 + 26 + n4 + n6);
            if (n7 < 4) {
