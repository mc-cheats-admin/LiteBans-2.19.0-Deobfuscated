...
extends BansHandler {
    ...
    public void BaseCoreGenericHandler(@NotNull String string, @NotNull Connection connection, @NotNull LiteBansModule_83 ch2, boolean flag) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            ch2.BaseCoreGenericHandler(connection, kL3, ((ConfigService)messageHandler.LiteBansModule_241().BaseCoreGenericHandler(ConfigService.class)).LiteBansModule_195().ai());
        }
        long l5 = ch2.c();
        this.g().set(l5 - l3);
    }
    ...
    public void BaseCoreGenericHandler(@NotNull CommandSenderWrapper sender) {
        ChatFormatter.BaseCoreGenericHandler(MessageHandler.BaseCoreGenericHandler, sender, MessageKey.LiteBansModule_88.BaseCoreGenericHandler("amount", (Object)this.g().get()), null, 4, null);
    }
    ...
    static {
        LitebansHandler_2.BaseCoreGenericHandler();
    }
}
