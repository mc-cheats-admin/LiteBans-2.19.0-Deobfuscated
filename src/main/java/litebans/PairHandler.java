...
extends DefaultvalueHandler_3 {
    ...
    private static final void LiteBansModule_31() {
        LiteBansModule_31 = new String[]{"pair", "builderAction", "builderAction", "builder", "<this>", "defaultValue", "<this>", "<this>", "comparator", "pairs", "comparator", "pairs", "<this>", "<this>", "<this>"};
    }

    static {
        PairHandler.LiteBansModule_31();
    }
}
