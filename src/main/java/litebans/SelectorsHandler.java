...
static class SelectorsHandler {
        public static final int BaseCoreGenericHandler(@Nullable Comparable comparable, @Nullable Comparable comparable2) {
    ...
    static {
        SelectorsHandler.BaseCoreGenericHandler();
    }
}
