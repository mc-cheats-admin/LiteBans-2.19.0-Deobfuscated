...
public class LiteBansModule_229 {
    ...
    public static String BaseCoreGenericHandler(byte[] byArray, boolean flag) {
        return new String(LiteBansModule_229.LiteBansModule_31(byArray, flag));
    }

    static {
        LiteBansModule_229.BaseCoreGenericHandler();
        ...
        for (int i = 0; i < n; ++i) {
            LiteBansModule_229.c[LiteBansModule_229.AsyncBackgroundTask_5[i]] = i;
        }
        LiteBansModule_229.c[61] = 0;
    }

    private static final void BaseCoreGenericHandler() {
        LiteBansModule_31 = new String[]{"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"};
    }
}
