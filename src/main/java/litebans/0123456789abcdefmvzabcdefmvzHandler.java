...
public final class 0123456789abcdefmvzabcdefmvzHandler {
    public static final 0123456789abcdefmvzabcdefmvzHandler BaseCoreGenericHandler;
    private static final HashSet AsyncBackgroundTask_5;
    private static final HashSet c;
    private static final HashSet e;
    private 0123456789abcdefmvzabcdefmvzHandler() {
    }

    public final String g(@Nullable String string) {
        String string2 = string;
        return string2 == null ? null : 0123456789abcdefmvzabcdefmvzHandler.LiteBansModule_194(string2);
    }

    public static final String LiteBansModule_194(@NotNull String string) {
        String string2 = string;
    ...
    public final UUID GnuSparseMapHandler(@NotNull String string) {
        String string2 = 0123456789abcdefmvzabcdefmvzHandler.LiteBansModule_194(string);
        if (0123456789abcdefmvzabcdefmvzHandler.BaseCoreGenericHandler(string2)) {
    ...
    public final boolean LiteBansModule_31(@Nullable String string) {
        return this.AsyncBackgroundTask_5(string) || this.LiteBansModule_240(string);
    }
     ...
     * Lifted jumps to return sites
     */
    public final boolean LiteBansModule_240(@Nullable String string) {
        boolean flag;
        char c;
        char c10;
        int n;
        ...
        while (n < charSequence.length()) {
            c = c10 = charSequence.charAt(n);
            flag = false;
            if (!0123456789abcdefmvzabcdefmvzHandler.c.contains(Character.valueOf(c))) {
                return false;
            }
            ++n;
        }
    ...
    public final NameHandler_3 Utf8Handler_2(@NotNull String string) {
        ...
        if (this.i(string2)) {
            ...
            string2 = 0123456789abcdefmvzabcdefmvzHandler.LiteBansModule_194(string2);
            by2 = 1;
        }
    ...
    static {
        0123456789abcdefmvzabcdefmvzHandler.BaseCoreGenericHandler();
        BaseCoreGenericHandler = new 0123456789abcdefmvzabcdefmvzHandler();
