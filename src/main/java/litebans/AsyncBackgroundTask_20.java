...
implements Runnable {
    public static final LiteBansModule_117 c;
    private final LiteBansModule_161 e = ProxyConnection.BaseCoreGenericHandler(() -> AsyncBackgroundTask_20.BaseCoreGenericHandler(this));
    ...
    public void run() {
{
    ...
    private final void BaseCoreGenericHandler(LiteBansModule_82 ch2, CommandSenderWrapper[] jv_0Array) {
        BroadcastService o2 = (BroadcastService)ch2.e().BaseCoreGenericHandler(BroadcastService.class);
        GeoIPLookupService_3 gu2 = o2.c();
        ObjectUtilities.LiteBansModule_31(gu2, "");
        KickOtherHandler gx_02 = (KickOtherHandler)gu2;
        ...
        boolean flag;
{
    ...
    private static final boolean BaseCoreGenericHandler(AsyncBackgroundTask_20 r_02, LiteBansModule_82 ch2, CommandSenderWrapper[] jv_0Array, SilentHandler dZ2) {
        ObjectUtilities.BaseCoreGenericHandler(jv_0Array);
