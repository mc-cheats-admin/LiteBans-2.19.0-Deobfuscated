...
public class LiteBansModule_155
implements CommandSenderWrapper {
    ...
    private final boolean GnuSparseMapHandler;
        public LiteBansModule_155(BungeePlugin bungeePlugin, CommandSender commandSender) {
        this.i = bungeePlugin;
        this.e = new WeakReference<CommandSender>(commandSender);
        this.GnuSparseMapHandler = commandSender instanceof ProxiedPlayer;
        this.LiteBansModule_195 = commandSender.getName();
    }
    ...
    public int LiteBansModule_31() {
        ...
        if (targetObj instanceof ProxiedPlayer) {
            PendingConnection pendingConnection = ((ProxiedPlayer)targetObj).getPendingConnection();
    ...
    public boolean equals(Object targetObj) {
        return this == targetObj || targetObj instanceof LiteBansModule_155 && ((LiteBansModule_155)targetObj).AsyncBackgroundTask_5().equals(this.AsyncBackgroundTask_5());
    }
    ...
    public void LiteBansModule_31(String string) {
        ...
        if (LiteBansModule_57.LiteBansModule_31()) {
            if (this.LiteBansModule_31() >= 770) {
                commandSender.sendMessage(LiteBansModule_281.BaseCoreGenericHandler(string, ChatVersion.V1_21_5));
            } else {
                commandSender.sendMessage(LiteBansModule_281.BaseCoreGenericHandler(string, ChatVersion.V1_16));
            }
        } else {
    ...
    private static final void BaseCoreGenericHandler() {
        LiteBansModule_241 = new String[]{"00000000-0000-0000-0000-000000000000", "reason is marked non-null but is null"};
    }

    static {
        LiteBansModule_155.BaseCoreGenericHandler();
    }
}
