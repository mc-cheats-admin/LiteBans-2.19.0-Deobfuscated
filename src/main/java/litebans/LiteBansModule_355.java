...
public final class LiteBansModule_355
implements LiteBansModule_51 {
    private final PlatformPlugin BaseCoreGenericHandler;
    private final LiteBansModule_99 c;
        public LiteBansModule_355(@NotNull PlatformPlugin plugin, @NotNull LiteBansModule_99 cr_02) {
        this.plugin = plugin;
        this.c = cr_02;
    }
    ...
    public LiteBansModule_355 c() {
        LiteBansModule_355 jS2;
        LiteBansModule_355 jS3 = jS2 = this;
    ...
    public final void BaseCoreGenericHandler(@NotNull class_3248 class_32482, @NotNull MinecraftServer minecraftServer, @NotNull LoginPacketSender loginPacketSender, @NotNull ServerLoginNetworking.LoginSynchronizer loginSynchronizer) {
        ...
        h82.BaseCoreGenericHandler(class_32482, loginSynchronizer, new LiteBansModule_96(gameProfile.name(), gameProfile.SQLiteDriverHandler_4().toString(), this.c.BaseCoreGenericHandler(class_25352)), class_25352);
    }
    ...
    static {
        LiteBansModule_355.AsyncBackgroundTask_5();
    }
}
