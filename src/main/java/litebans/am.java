...
implements CharSequence {
    ...
    public static final am df = new am("DEFAULT_UNBAN_REASON", 26, "default_unban_reason", (CharSequence)"No reason ");
    public static final am R = new am("DEFAULT_UNMUTE_REASON", 27, "default_unmute_reason", (CharSequence)"No reason ");
    public static final am cu = new am("DEFAULT_UNWARN_REASON", 28, "default_unwarn_reason", (CharSequence)"No reason ");
    ...
    public static final am aN = new am("ERROR_NO_UUID", 48, "error_no_uuid_found", (CharSequence)(hd_0.c + "Player does not "));
    ...
    public static final am x = new am("ERROR_STACK_OVERFLOW", 50, "error_stack_overflow", (CharSequence)(hd_0.c + "Stack overflow "));
    public static final am b = new am("ERROR_CONSOLE", 51, "error_console_only", (CharSequence)(hd_0.c + "This command can only be used from "));
    ...
    public static final am c6 = new am("ERROR_INTERNAL", 53, "internal_error", (CharSequence)(hd_0.c + "An internal error occurred while attempting to perform this "));
    ...
    public static final am dB = new am("BAN_PREVIOUS_BAN_REMOVED", 61, a, "previous_ban_removed", (CharSequence)hd_0.c("Previous ban for $playerName "));
    public static final am b3 = new am("BAN_PREVIOUS_BAN_EXISTING", 62, a, "previous_ban_existing", (CharSequence)hd_0.f("$playerName is already banned, and you do not have permission to replace existing "));
    ...
    public static final am b5 = new am("BAN_COOLDOWN", 69, a, "cooldown", (CharSequence)hd_0.f("You need to wait " + hd_0.d("$duration") + hd_0.f(" before you can use this command ")));
    public static final am D = new am("BAN_RESPONSE", 70, a, "response", (CharSequence)"");
    public static final am cj = new am("BAN_MODIFY_SUCCESS", 71, a, "modify_success", (CharSequence)hd_0.c("Punishment modified "));
    public static final am af = new am("BAN_DELETE_SUCCESS", 72, a, "delete_success", (CharSequence)hd_0.c("Punishment deleted "));
    ...
    public static final am aJ = new am("UNBAN_QUEUED", 76, a, "unban_queued", (CharSequence)(hd_0.c + "Target is not banned!" + hd_0.m + " If they try to reconnect, they will be "));
    ...
    public static final am u = new am("MUTE_PREVIOUS_MUTE_REMOVED", 87, cQ, "previous_mute_removed", (CharSequence)(hd_0.i + "Previous mute for $playerName "));
    public static final am aR = new am("MUTE_PREVIOUS_MUTE_EXISTING", 88, cQ, "previous_mute_existing", (CharSequence)(hd_0.c + "$playerName is already muted, and you do not have permission to replace existing "));
    public static final am cY = new am("MUTE_EXEMPT", 89, cQ, "exempt", (CharSequence)(hd_0.c + "You can't mute $player!"));
    public static final am bP = new am("MUTE_NOTIFY", 90, cQ, "notification", (CharSequence)(hd_0.c + "$playerDisplayName tried to speak, but is "));
    ...
    public static final am dL = new am("KICK_NO_MATCH", 107, bk, "no_match", (CharSequence)(hd_0.c + "Error: " + hd_0.F + "Player not "));
    public static final am dz = new am("KICK_REQUEST", 108, bk, "kick_requested", (CharSequence)(hd_0.m + "Player $player is not online on this server. Cross-server kick has been "));
    public static final am bf = new am("KICK_REASON", 109, bk, "message", (CharSequence)"Kicked by $executor: $reason");
    public static final am bm = new am("KICK_REASON_EMPTY", 110, bk, "message_no_reason", (CharSequence)"Kicked by $");
    public static final am cs = new am("KICK_RESPONSE", 111, bk, "response", (CharSequence)(hd_0.m + "$playerDisplayName has been "));
    ...
    public static final am bi = new am("HISTORY_ERROR_NO_LOGINRECORD", 127, ch, "error_no_loginrecord", (CharSequence)(hd_0.c + "User has not joined "));
    public static final am al = new am("HISTORY_ERROR_NO_USER", 128, ch, "error_no_user", (CharSequence)(hd_0.c + "User not "));
    ...
    public static final am aK = new am("PRUNEHISTORY_MESSAGE", 132, c_, "message", (CharSequence)(hd_0.i + "History "));
    ...
    public static final am M = new am("IPHISTORY_ERROR_NO_HISTORY", 141, bZ, "error_no_history", (CharSequence)(hd_0.c + "No history "));
    ...
    public static final am da = new am("GEOIP_NONE_FOUND", 173, ag, "error_not_found", (CharSequence)(hd_0.c + "GeoIP information for $target not "));
    ...
    public static final am X = new am("LOCKDOWN_END", 176, I, "stopped", (CharSequence)(hd_0.i + "Lockdown has been "));
    ...
    public static final am aW = new am("RELOAD_SUCCESS", 180, i, "reload_success", (CharSequence)(hd_0.i + "LiteBans reloaded "));
    public static final am ar = new am("RELOAD_FAIL", 181, i, "reload_fail", (CharSequence)(hd_0.c + "Reload "));
    public static final am bM = new am("RELOAD_FAIL_CONNECT", 182, i, "reload_fail_connect", (CharSequence)(hd_0.i + "Litebans " + hd_0.c + "Failed to connect to "));
    public static final am bU = new am("RELOAD_FAIL_CONFIG", 183, i, "reload_fail_config", (CharSequence)(hd_0.c + "[LiteBans] " + hd_0.F + "config.yml is not valid and could not be loaded, the default configuration will be used.\\n" + hd_0.c + "Please check the server console for more "));
    ...
    public static final am c1 = new am("FIXHISTORY_END", 187, i, "fix_history_result", (CharSequence)(hd_0.i + "Added $amount "));
    public static final am aw = new am("FIXHISTORY_OFFLINE_UUIDS", 188, i, "fix_history_offline_uuids", (CharSequence)(hd_0.c + "$amount UUIDs were not fetched from Mojang since they are offline-mode "));
    ...
    public static final am bo = new am("IMPORT_FINISH", 191, i, "import_finish", (CharSequence)(hd_0.i + "Import finished successfully. $bans bans imported, $ipbans IP-"));
    public static final am cL = new am("IMPORT_FINISH_LITEBANS", 192, i, "import_finish_litebans", (CharSequence)(hd_0.i + "Import finished successfully. Added $amount entries to the "));
    public static final am b9 = new am("IMPORT_FAIL", 193, i, "import_fail", (CharSequence)(hd_0.c + "Import failed. Check "));
    ...
    public static final am bq = new am("ALLOW_CHECK_TRUE", 198, i, "allow_check_true", (CharSequence)(hd_0.i + "Player " + hd_0.m + "$playerName" + hd_0.i + " is allowed to join the "));
    public static final am bO = new am("ALLOW_CHECK_FALSE", 199, i, "allow_check_false", (CharSequence)(hd_0.c + "Player " + hd_0.m + "$playerName" + hd_0.c + " is not allowed to join the "));
    public static final am cD = new am("ALLOW_ERROR_ADD", 200, i, "allow_error_add", (CharSequence)(hd_0.c + "Error: $playerName is already allowed to join the "));
    public static final am bg = new am("ALLOW_ERROR_REMOVE", 201, i, "allow_error_remove", (CharSequence)(hd_0.c + "Error: $playerName is not allowed to join the "));
    public static final am dj = new am("RESET_DATABASE_CONFIRM", 202, i, "reset_database_confirm_quoted", (CharSequence)("\n" + hd_0.c + "WARNING: " + hd_0.u + "This command will reset your database, removing all active and inactive punishments permanently.\n" + hd_0.c + "WARNING: " + hd_0.r + "This operation is irreversible without restoring a database backup.\n" + hd_0.u + "Run '" + hd_0.c + "litebans $commandArgs confirm" + hd_0.u + "' to "));
