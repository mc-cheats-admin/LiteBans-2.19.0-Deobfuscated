...
implements LiteBansModule_51 {
    ...
    private final LiteBansModule_99 BaseCoreGenericHandler;
        public LiteBansModule_303(@NotNull PlatformPlugin plugin, @NotNull LiteBansModule_99 cr_02) {
        this.c = plugin;
        this.plugin = cr_02;
    }
    ...
    public final LiteBansModule_99 BaseCoreGenericHandler() {
        return this.plugin;
    }

    public LiteBansModule_303 c() {
        LiteBansModule_303 ie2;
        LiteBansModule_303 ie3 = ie2 = this;
    ...
    public final void BaseCoreGenericHandler(@NotNull class_3248 class_32482, @NotNull MinecraftServer minecraftServer, @NotNull PacketSender packetSender, @NotNull ServerLoginNetworking.LoginSynchronizer loginSynchronizer) {
        ...
        h82.BaseCoreGenericHandler(class_32482, loginSynchronizer, new LiteBansModule_96(gameProfile.getName(), gameProfile.getId().toString(), this.plugin.BaseCoreGenericHandler(class_25352)), class_25352);
    }
    ...
    static {
        LiteBansModule_303.AsyncBackgroundTask_5();
    }
}
