...
implements LiteBansModule_89 {
    ...
    public final void BaseCoreGenericHandler(@NotNull PlayerJoinEvent playerJoinEvent) {
        ...
        LiteBansModule_159 ec_02 = this.LiteBansModule_31.i();
        ...
        LiteBansModule_279 hv_02 = new LiteBansModule_279();
     ...
     */
    private final void BaseCoreGenericHandler(LiteBansModule_83 ch2, CommandSenderWrapper sender, String string, String string2, String string3, SilentHandler dZ2, BroadcastService o2, ConfigService configService, LiteBansModule_83 ch3) {
        try {
            if (configService.LiteBansModule_195().aM()) {
                CharSequence charSequence = ch2.BaseCoreGenericHandler(AllHandler_3.BaseCoreGenericHandler(ch2, (CharSequence)MessageKey.LiteBansModule_241, dZ2, false, 2, null), sender);
    ...
    public PlayerJoinListener BaseCoreGenericHandler() {
        ...
        LiteBansModule_176[] em_0Array = new LiteBansModule_176[]{dy3};
        dy3.LiteBansModule_31.LiteBansModule_31(em_0Array);
        return dy2;
    }

    private static final KotlinUnitHandler BaseCoreGenericHandler(Player player, String string, String string2, ConfigService configService, BroadcastService o2, String string3, PlayerJoinListener dy2, LiteBansModule_279 hv_02, DatabaseMonitorService w2, LiteBansModule_83 ch2) {
        SilentHandler dZ2;
        LiteBansModule_83 ch3 = ch2;
        CommandSenderWrapper sender = ch2.e().BaseCoreGenericHandler(player);
        SilentHandler dZ3 = AllHandler_3.BaseCoreGenericHandler(ch2, string, string2, BanHandler.LiteBansModule_241, false, false, 24, null);
        ...
        if (!hv_02.BaseCoreGenericHandler && configService.LiteBansModule_195().NullHandler() && (dZ2 = AllHandler_3.BaseCoreGenericHandler(ch2, string3, string, w2.ServerSyncService(), null, 8, null)) != null) {
            ObjectUtilities.BaseCoreGenericHandler(sender);
            ObjectUtilities.BaseCoreGenericHandler(o2);
            ObjectUtilities.BaseCoreGenericHandler(configService);
    ...
    static {
        PlayerJoinListener.LiteBansModule_31();
    }
}
