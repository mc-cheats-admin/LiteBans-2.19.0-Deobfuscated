...
extends Enum {
    ...
    public static final TransactionNoneHandler LiteBansModule_194 = new TransactionNoneHandler("TRANSACTION_READ_UNCOMMITTED", 1, 1);
    ...
    public static final TransactionNoneHandler LiteBansModule_240 = new TransactionNoneHandler("TRANSACTION_SERIALIZABLE", 4, 8);
