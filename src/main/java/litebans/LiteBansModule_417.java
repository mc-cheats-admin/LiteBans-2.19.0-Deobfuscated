...
public abstract class LiteBansModule_417
implements Statement {
    ...
    LiteBansModule_417(LiteBansModule_66 c22, Statement statement) {
    ...
    public ResultSet getResultSet() {
        ...
        if (resultSet != null) {
            if (this.AsyncBackgroundTask_5 == null || ((LiteBansModule_224)this.AsyncBackgroundTask_5).LiteBansModule_31 != resultSet) {
