...
extends FilterInputStream {
    ...
    private int LiteBansModule_194 = 1024;
    ...
    public void BaseCoreGenericHandler(int n, boolean flag) {
        ...
        this.LiteBansModule_194 = 1024 * n;
        byte[] byArray = this.plugin;
        this.plugin = new byte[this.LiteBansModule_194];
        System.arraycopy(byArray, 0, this.plugin, 0, 1024);
        this.plugin(this.plugin, 1024, this.LiteBansModule_194 - 1024);
    ...
    public int available() {
        if (this.c < this.LiteBansModule_194) {
            return this.LiteBansModule_194 - this.c;
        }
    ...
    private final void BaseCoreGenericHandler(boolean flag) {
        ...
        if (!this.AsyncBackgroundTask_5 || this.LiteBansModule_31 == -1) {
            ...
            this.e += 4L;
            int n = LiteBansModule_108.LiteBansModule_31(this.plugin, 0);
                    ...
                    switch (ZlibHandler.BaseCoreGenericHandler(n2 & 3)) {
                        case c: {
                            ...
                            try {
                                ...
                                if (n3 != this.LiteBansModule_194) {
                                    throw new LiteBansModule_320();
                                }
                                break;
                            }
                            catch (DataFormatException dataFormatException) {
                                throw new LiteBansModule_300("Bad data", dataFormatException);
                            }
                            finally {
                                inflater.end();
}
                        ...
                        case AsyncBackgroundTask_5: {
                            throw new LiteBansModule_310("LZO");
                        }
                        default: {
