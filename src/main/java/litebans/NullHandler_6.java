...
public class NullHandler_6 {
    ...
    public static Iterable BaseCoreGenericHandler(Object targetObj) {
        if (targetObj instanceof LiteBansModule_122 && !(targetObj instanceof LiteBansModule_312)) {
    ...
    public static Collection LiteBansModule_31(Object targetObj) {
        if (targetObj instanceof LiteBansModule_122 && !(targetObj instanceof LiteBansModule_269)) {
    ...
    public static List c(Object targetObj) {
        if (targetObj instanceof LiteBansModule_122 && !(targetObj instanceof LiteBansModule_399)) {
            NullHandler_6.BaseCoreGenericHandler(targetObj, "kotlin.collections.MutableList");
        }
        return NullHandler_6.LiteBansModule_194(targetObj);
    }

    public static List LiteBansModule_194(Object targetObj) {
        try {
