...
public interface LiteBansModule_82
extends Closeable {
    ...
    public LiteBansModule_297 BaseCoreGenericHandler(@NotNull LiteBansModule_297 var1, boolean var2);
    ...
    public LiteBansModule_297 BaseCoreGenericHandler(@NotNull ResultSet var1, boolean var2, @Nullable String var3);
    ...
    public LiteBansModule_297 c(@Nullable String var1);
    ...
    public LiteBansModule_354 BaseCoreGenericHandler(@Nullable String var1, @Nullable String var2, @NotNull LiteBansModule_174 var3, @NotNull LiteBansModule_65 var4);
    ...
    public int BaseCoreGenericHandler(@NotNull LiteBansModule_297 var1);
    ...
    public List BaseCoreGenericHandler(@NotNull LiteBansModule_297 var1, @NotNull BanHandler var2, @NotNull String var3, boolean var4, int var5);
    ...
    public CharSequence BaseCoreGenericHandler(@NotNull CharSequence var1, @Nullable LiteBansModule_297 var2, boolean var3);

    public CharSequence BaseCoreGenericHandler(@NotNull CharSequence var1, @Nullable CommandSenderWrapper var2);

    public CharSequence BaseCoreGenericHandler(@NotNull CharSequence var1, @NotNull LiteBansModule_113 var2);
    ...
    public CharSequence BaseCoreGenericHandler(@NotNull CharSequence var1, @Nullable SilentHandler var2, @Nullable LiteBansModule_297 var3, boolean var4);
