...
public final class LiteBansModule_277
implements ProxiedPlayer {
    ...
    public LiteBansModule_277(CommandSenderWrapper sender, ServerInfo serverInfo) {
        this.plugin = sender;
    ...
    public Server getServer() {
        return new LiteBansModule_70(this.LiteBansModule_31);
    }
