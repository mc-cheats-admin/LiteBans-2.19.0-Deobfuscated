...
public abstract class LiteBansModule_66
implements Connection {
    static final int AsyncBackgroundTask_5;
    static final int Utf8Handler_2;
    static final int LiteBansModule_403;
    ...
    private final InUseHandler LiteBansModule_241;
    private final AsyncBackgroundTask_15 i;
    private final LiteBansModule_227 g;
    ...
    protected LiteBansModule_66(InUseHandler kJ2, Connection connection, LiteBansModule_227 gk2, AsyncBackgroundTask_15 ja2, long l3, boolean flag, boolean flag2) {
        this.LiteBansModule_241 = kJ2;
        this.r = connection;
        this.g = gk2;
        this.i = ja2;
    ...
    final boolean LiteBansModule_195() {
        return this.m;
    }
    ...
    final SQLException BaseCoreGenericHandler(SQLException sQLException) {
        ...
        LiteBansModule_100 cs2 = this.LiteBansModule_241.AsyncBackgroundTask_5().CommandThrottleService;
        ...
        if (flag) {
            ...
            n.c("%AsyncBackgroundTask_21 - Connection %AsyncBackgroundTask_21 marked CommandExitException broken because of SQLSTATE(%AsyncBackgroundTask_21), ErrorCode(%AsyncBackgroundTask_5)", new Object[]{this.LiteBansModule_241.e(), this.r.toString(), sQLException3.getSQLState(), sQLException3.getErrorCode(), sQLException3});
            this.i.BaseCoreGenericHandler();
            this.LiteBansModule_241.BaseCoreGenericHandler("(connection is broken)");
    ...
    final void LiteBansModule_31() {
        if (this.GnuSparseMapHandler) {
            this.CommandThrottleService = LiteBansModule_150.LiteBansModule_31();
        } else {
        ...
        if (n > 0) {
            for (int i = 0; i < n && this.r != IsclosedHandler.BaseCoreGenericHandler; ++i) {
                try {
                    ...
                    LiteBansModule_66.n.c("%AsyncBackgroundTask_21 - Connection %AsyncBackgroundTask_21 marked CommandExitException broken because of HikariDataSource exception closing open statements during Connection.close()", new Object[]{this.LiteBansModule_241.e(), this.r.toString()});
                    this.i.BaseCoreGenericHandler();
                    this.LiteBansModule_241.BaseCoreGenericHandler("(exception closing Statements during Connection.close())");
                    this.r = IsclosedHandler.BaseCoreGenericHandler;
                }
            }
            this.g.clear();
        ...
        if (this.r != IsclosedHandler.BaseCoreGenericHandler) {
            ...
            try {
                if (this.PunishmentTableService && !this.GnuSparseMapHandler) {
                    this.r.rollback();
                    this.CommandThrottleService = LiteBansModule_150.LiteBansModule_31();
                    n.LiteBansModule_31("%AsyncBackgroundTask_21 - Executed rollback on connection %AsyncBackgroundTask_21 due to dirty commit state on close() + ", new Object[]{this.LiteBansModule_241.e(), this.r.toString()});
                }
                if (this.BroadcastService != 0) {
                    this.LiteBansModule_241.BaseCoreGenericHandler(this, this.BroadcastService);
                    this.CommandThrottleService = LiteBansModule_150.LiteBansModule_31();
                }
                this.r.clearWarnings();
            }
            catch (SQLException sQLException) {
                if (!this.LiteBansModule_241.LiteBansModule_31()) {
                    throw this.plugin(sQLException);
                }
            }
            finally {
                this.r = IsclosedHandler.BaseCoreGenericHandler;
                this.LiteBansModule_241.BaseCoreGenericHandler(this.CommandThrottleService);
            }
        }
    }
    ...
    static {
        ...
        LiteBansModule_403 = 4;
        Utf8Handler_2 = 2;
        AsyncBackgroundTask_5 = 1;
        n = HikariLogger.BaseCoreGenericHandler(LiteBansModule_66.class);
