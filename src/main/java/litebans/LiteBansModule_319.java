...
public final class LiteBansModule_319 {
        private LiteBansModule_319() {
    }
    ...
    public final String BaseCoreGenericHandler(@NotNull String string) {
        if (StringUtilities.c((CharSequence)string, '#', false, 2, null)) {
            ...
            block14: {
                ...
                contextObj = StringUtilities.BaseCoreGenericHandler((CharSequence)MessageKey.LiteBansModule_50, contextObj, false, 0, 6, null);
                ...
                if (targetObj instanceof Collection && ((Collection)targetObj).isEmpty()) {
                    ...
                    while (resultObj.hasNext()) {
                        ...
                        helperObj = (String)e;
                        char c = StringUtilities.BaseCoreGenericHandler((CharSequence)helperObj);
                        String string3 = "#";
            ...
            boolean flag7 = flag2;
            Object tempObj = targetObj = (Object)string.toCharArray();
            n = 0;
            for (Object object6 : tempObj) {
                ...
                int n3 = n2;
                flag = false;
                if (object7 != 35 || ((Object)targetObj).length <= n3 + 6) continue;
                ...
                if (flag7) {
                    ...
                    for (Object t3 : iterable) {
                        ...
                        collection.add(LiteBansModule_373.BaseCoreGenericHandler(String.format(string7, Arrays.copyOf(objectArray, objectArray.length)), string5));
                    }
                }
                ((Collection)arrayList).add(LiteBansModule_373.BaseCoreGenericHandler(string4, string5));
            }
            tempObj = string;
            flag8 = false;
            Object object9 = null;
            ...
            for (Object t4 : iterable) {
                LiteBansModule_356 jT2 = (LiteBansModule_356)t4;
                flag = false;
    ...
    private final String LiteBansModule_31(String string) {
        StringBuilder stringBuilder;
        StringBuilder stringBuilder2 = stringBuilder = new StringBuilder(22).append('\u00a7').append('LiteBansModule_435');
    ...
    public /* synthetic */ LiteBansModule_319(LiteBansModule_14 aJ2) {
        this();
    }
    ...
    static {
        LiteBansModule_319.BaseCoreGenericHandler();
    }
}
