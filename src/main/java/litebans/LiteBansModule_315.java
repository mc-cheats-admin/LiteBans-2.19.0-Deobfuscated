...
public class LiteBansModule_315 {
    ...
    private LiteBansModule_242 LiteBansModule_195 = new LiteBansModule_242(null);
    ...
    public void BaseCoreGenericHandler(Reader reader) {
        this.LiteBansModule_195.BaseCoreGenericHandler(reader);
        this.LiteBansModule_31();
    }

    public int c() {
        return this.LiteBansModule_195.c();
    }

    public Object BaseCoreGenericHandler(String string) {
        return this.plugin(string, (LiteBansModule_359)null);
    }

    public Object BaseCoreGenericHandler(String string, LiteBansModule_359 ju_02) {
    ...
    public Object LiteBansModule_31(Reader reader) {
        return this.plugin(reader, (LiteBansModule_359)null);
    }

    public Object BaseCoreGenericHandler(Reader reader, LiteBansModule_359 ju_02) {
        this.plugin(reader);
        ...
        do {
            ...
            block1 : switch (this.c) {
                case 0: {
                    switch (this.GnuSparseMapHandler.LiteBansModule_241) {
                        case 0: {
                            this.c = 1;
                ...
                case 1: {
                    if (this.GnuSparseMapHandler.LiteBansModule_241 == -1) {
                    ...
                    switch (this.GnuSparseMapHandler.LiteBansModule_241) {
                        ...
                        case 0: {
                            if (this.GnuSparseMapHandler.e instanceof String) {
                                targetObj = (String)this.GnuSparseMapHandler.e;
            ...
            throw new UnexpectedTokenException(this.c(), 1, this.GnuSparseMapHandler);
        } while (this.GnuSparseMapHandler.LiteBansModule_241 != -1);
        throw new UnexpectedTokenException(this.c(), 1, this.GnuSparseMapHandler);
    }

    private final void BaseCoreGenericHandler() {
        this.GnuSparseMapHandler = this.LiteBansModule_195.e();
        if (this.GnuSparseMapHandler == null) {
            this.GnuSparseMapHandler = new LiteBansModule_55(-1, null);
        }
    }

    private final Map LiteBansModule_31(LiteBansModule_359 ju_02) {
        if (ju_02 == null) {
    ...
    private final List BaseCoreGenericHandler(LiteBansModule_359 ju_02) {
        if (ju_02 == null) {
    ...
    static {
        ...
        LiteBansModule_403 = 2;
        LiteBansModule_241 = 1;
        Utf8Handler_2 = 0;
    }
}
