...
public interface LiteBansModule_150 {
    public static final LiteBansModule_150 LiteBansModule_31 = OsNameHandler.LiteBansModule_31();
    ...
    public static final String[] BaseCoreGenericHandler = new String[]{"ns", "\u00b5s", "ms", "AsyncBackgroundTask_21", "m", "LiteBansModule_241", "AsyncBackgroundTask_5"};
    ...
    public static long g(long a10, long a11) {
        return LiteBansModule_31.LiteBansModule_195(a10, a11);
    }

    public long LiteBansModule_195(long var1, long var3);
