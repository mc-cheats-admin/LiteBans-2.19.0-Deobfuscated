...
extends MessageHandler {
    ...
    private static final void BaseCoreGenericHandler(ServerSyncService u2, LiteBansModule_349 jn2, CopyOnWriteArrayList copyOnWriteArrayList, CommandSenderWrapper sender) {
        ...
        if (n <= 1) {
            ...
            targetObj = LiteBansModule_242.BaseCoreGenericHandler(BlackHandler.i, "\uaa67\uaa5b\uaa56\uaa41\uaa56\uaa13\uaa52\uaa41\uaa56\uaa13") + BlackHandler.m + n + BlackHandler.i + " servers connected to this database: " + LiteBansModule_378.BaseCoreGenericHandler.BaseCoreGenericHandler(collection.toArray(new Object[0]), ", ");
            flag = false;
            ChatFormatter.BaseCoreGenericHandler(MessageHandler.BaseCoreGenericHandler, senderWrapper, targetObj, null, 4, null);
}
    ...
    private static final KotlinUnitHandler BaseCoreGenericHandler(LiteBansModule_197 f32, LiteBansModule_82 ch2) {
        if (ch2.AsyncBackgroundTask_5().AsyncBackgroundTask_21()) {
            ...
            String string = ((ConfigService)targetObj.LiteBansModule_240().BaseCoreGenericHandler(ConfigService.class)).LiteBansModule_194().AsyncBackgroundTask_5();
            ...
            CommandArgumentUtils.BaseCoreGenericHandler((MessageHandler)f32, LiteBansModule_242.BaseCoreGenericHandler(BlackHandler.i, "Checking for other servers connected to the database, please wait.. + "));
            LiteBansModule_349 jn2 = new LiteBansModule_349((String)targetObj, copyOnWriteArrayList);
            u2.BaseCoreGenericHandler(jn2);
            ServerSyncService.BaseCoreGenericHandler(u2, BroadcastHandler.e, ch2, targetObj, 0, 8, null);
