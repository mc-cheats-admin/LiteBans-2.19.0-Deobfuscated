...
Cloneable {
    ...
    public LiteBansModule_289 LiteBansModule_31() {
        return new LiteBansModule_289(14 + this.c().getBytes().length);
    }
    ...
    public byte[] e() {
        ...
        System.arraycopy(LiteBansModule_289.BaseCoreGenericHandler(this.e()), 0, byArray, 0, 2);
        byte[] byArray2 = this.c().getBytes();
        System.arraycopy(LiteBansModule_85.BaseCoreGenericHandler(byArray2.length), 0, byArray, 2, 4);
        System.arraycopy(LiteBansModule_289.BaseCoreGenericHandler(this.LiteBansModule_31()), 0, byArray, 6, 2);
        System.arraycopy(LiteBansModule_289.BaseCoreGenericHandler(this.AsyncBackgroundTask_5()), 0, byArray, 8, 2);
        ...
        System.arraycopy(LiteBansModule_85.BaseCoreGenericHandler(l3), 0, byArray3, 0, 4);
    ...
    public boolean BaseCoreGenericHandler() {
        return this.BroadcastService && !this.LiteBansModule_195();
    }

    @Override
    public void BaseCoreGenericHandler(byte[] byArray, int n, int n2) {
        long l3 = LiteBansModule_85.BaseCoreGenericHandler(byArray, n);
        ...
        int n3 = LiteBansModule_289.BaseCoreGenericHandler(byArray2, 0);
        byte[] byArray3 = new byte[(int)LiteBansModule_85.BaseCoreGenericHandler(byArray2, 2)];
        this.GnuSparseMapHandler = LiteBansModule_289.BaseCoreGenericHandler(byArray2, 6);
        this.LiteBansModule_403 = LiteBansModule_289.BaseCoreGenericHandler(byArray2, 8);
    ...
    public Object clone() {
        try {
            LiteBansModule_307 ii_02 = (LiteBansModule_307)super.clone();
    ...
    static {
        ...
        n = new LiteBansModule_289(30062);
    }
}
