...
extends KlassHandler_2 {
    ...
    public static final Object BaseCoreGenericHandler(@NotNull Iterable iterable, int n, @NotNull LiteBansModule_179 eo_02) {
        ObjectUtilities.BaseCoreGenericHandler((Object)iterable, "<this>");
    ...
    public static final Object LiteBansModule_241(@NotNull Iterable iterable) {
        ObjectUtilities.BaseCoreGenericHandler((Object)iterable, "<this>");
        if (iterable instanceof List) {
    ...
    public static final List BaseCoreGenericHandler(@NotNull Iterable iterable, int n) {
        ...
        if (iterable instanceof Collection) {
            if (n >= ((Collection)iterable).size()) {
                return CollectionUtilities.LiteBansModule_195(iterable);
            }
            if (n == 1) {
                return CollectionUtilities.BaseCoreGenericHandler(CollectionUtilities.LiteBansModule_241(iterable));
            }
        }
    ...
    public static final HashSet g(@NotNull Iterable iterable) {
        ObjectUtilities.BaseCoreGenericHandler((Object)iterable, "<this>");
        return (HashSet)CollectionUtilities.BaseCoreGenericHandler(iterable, new HashSet(LiteBansModule_350.BaseCoreGenericHandler(CollectionUtilities.BaseCoreGenericHandler(iterable, 12))));
    }

    public static final List LiteBansModule_195(@NotNull Iterable iterable) {
        ObjectUtilities.BaseCoreGenericHandler((Object)iterable, "<this>");
        if (iterable instanceof Collection) {
            List list;
    ...
    public static final Set LiteBansModule_31(@NotNull Iterable iterable) {
        ...
        if (iterable instanceof Collection) {
            ...
            switch (((Collection)iterable).size()) {
                ...
                default: {
                    set = (Set)CollectionUtilities.BaseCoreGenericHandler(iterable, new LinkedHashSet(LiteBansModule_350.BaseCoreGenericHandler(((Collection)iterable).size())));
                }
            }
            return set;
        }
    ...
    public static final Appendable BaseCoreGenericHandler(@NotNull Iterable iterable, @NotNull Appendable appendable, @NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, int n, @NotNull CharSequence charSequence4, @Nullable LiteBansModule_179 eo_02) {
        ObjectUtilities.BaseCoreGenericHandler((Object)iterable, "<this>");
    ...
    public static final String BaseCoreGenericHandler(@NotNull Iterable iterable, @NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, @NotNull CharSequence charSequence3, int n, @NotNull CharSequence charSequence4, @Nullable LiteBansModule_179 eo_02) {
        ObjectUtilities.BaseCoreGenericHandler((Object)iterable, "<this>");
        ObjectUtilities.BaseCoreGenericHandler((Object)charSequence, "separator");
        ObjectUtilities.BaseCoreGenericHandler((Object)charSequence2, "prefix");
        ObjectUtilities.BaseCoreGenericHandler((Object)charSequence3, "postfix");
    ...
    public static /* synthetic */ String BaseCoreGenericHandler(Iterable iterable, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int n, CharSequence charSequence4, LiteBansModule_179 eo_02, int n2, Object targetObj) {
        if ((n2 & 1) != 0) {
            charSequence = ", ";
        }
        if ((n2 & 2) != 0) {
    ...
    static {
        DefaultvalueHandler_5.LiteBansModule_403();
    }
}
